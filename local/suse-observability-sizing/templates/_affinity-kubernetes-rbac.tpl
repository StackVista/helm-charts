...
{{/*
Get complete Kubernetes RBAC affinity configuration for HA profiles.
...
kubernetes-rbac:
  affinity: {{ include "common.sizing.kubernetes-rbac.affinityConfig" . | nindent 4 }}
...
Returns (for HA profiles with nodeAffinity):
  ...
  podAntiAffinity:
    ...
    - labelSelector:
        matchLabels:
          app.kubernetes.io/component: kubernetes-rbac
      topologyKey: kubernetes.io/hostname
*/}}
{{- define "common.sizing.kubernetes-rbac.affinityConfig" -}}
{{- $result := dict -}}
...
{{- $podAntiAffinity := include "common.sizing.kubernetes-rbac.affinity" . | trim -}}
{{- if $podAntiAffinity -}}
