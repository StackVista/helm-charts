...
| hdfs.version | string | `"java21-9-16889a20-release-402"` | The hadoop version is automatically derived from the hbase version, this is the specific build version of the HDFS image for that version |
