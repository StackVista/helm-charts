...
| hdfs.version | string | `"java21-9-0f68a2cf-release-399"` | The hadoop version is automatically derived from the hbase version, this is the specific build version of the HDFS image for that version |
