...
| config.connectors.topology.deduplication.cache.enable_metrics | bool | `true` |  |
| config.connectors.topology.deduplication.cache.size | int | `100000` |  |
| config.connectors.topology.deduplication.cache.ttl | string | `"1h"` |  |
| config.connectors.topology.deduplication.enabled | bool | `true` |  |
| config.connectors.topology.deduplication.refresh_fraction | float | `0.5` |  |
| config.connectors.topology.expression_cache.enable_metrics | bool | `true` |  |
| config.connectors.topology.expression_cache.size | int | `100000` |  |
| config.connectors.topology.expression_cache.ttl | int | `0` |  |
| config.connectors.topology.tag_regex_cache.enable_metrics | bool | `true` |  |
| config.connectors.topology.tag_regex_cache.size | int | `2000` |  |
| config.connectors.topology.tag_regex_cache.ttl | int | `0` |  |
| config.connectors.topology.tag_template_cache.enable_metrics | bool | `true` |  |
| config.connectors.topology.tag_template_cache.size | int | `2000` |  |
| config.connectors.topology.tag_template_cache.ttl | int | `0` |  |
...
| config.exporters.sts_kafka_exporter.brokers[0] | string | `"suse-observability-kafka-headless:9092"` |  |
| config.exporters.sts_kafka_exporter.produce_timeout | string | `"5s"` |  |
| config.exporters.sts_kafka_exporter.read_timeout | string | `"2s"` |  |
| config.exporters.sts_kafka_exporter.required_acks | string | `"none"` |  |
| config.exporters.sts_kafka_exporter.retry_on_failure.enabled | bool | `true` |  |
| config.exporters.sts_kafka_exporter.retry_on_failure.initial_interval | string | `"5s"` |  |
| config.exporters.sts_kafka_exporter.retry_on_failure.max_elapsed_time | string | `"300s"` |  |
| config.exporters.sts_kafka_exporter.retry_on_failure.max_interval | string | `"30s"` |  |
| config.exporters.sts_kafka_exporter.sending_queue.num_consumers | int | `10` |  |
...
| config.extensions.sts_settings_provider.kafka.brokers[0] | string | `"suse-observability-kafka-headless:9092"` |  |
| config.extensions.sts_settings_provider.kafka.topic | string | `"sts_internal_settings"` |  |
...
| config.processors.transform/semconv.trace_statements[0].context | string | `"span"` |  |
| config.processors.transform/semconv.trace_statements[0].statements[0] | string | `"delete_key(attributes, \"peer.service\") where attributes[\"db.system\"] == \"redis\""` |  |
| config.processors.transform/semconv.trace_statements[1].context | string | `"span"` |  |
| config.processors.transform/semconv.trace_statements[1].statements[0] | string | `"set(attributes[\"db.system\"], \"other_sql\") where attributes[\"db.type\"] == \"sql\" and attributes[\"db.system\"] == nil"` |  |
...
| config.service.extensions[2] | string | `"sts_settings_provider"` |  |
| config.service.pipelines.logs.exporters[0] | string | `"forward"` |  |
...
| config.service.pipelines.logs/topology.exporters[0] | string | `"sts_kafka_exporter"` |  |
| config.service.pipelines.logs/topology.receivers[0] | string | `"topology"` |  |
| config.service.pipelines.logs/topology_input.exporters[0] | string | `"topology"` |  |
| config.service.pipelines.logs/topology_input.processors[0] | string | `"resource/removeStsApiKey"` |  |
| config.service.pipelines.logs/topology_input.processors[1] | string | `"attributes/removeStsApiKey"` |  |
| config.service.pipelines.logs/topology_input.receivers[0] | string | `"forward"` |  |
