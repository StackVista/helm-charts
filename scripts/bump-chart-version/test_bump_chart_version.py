...
def fixtures(temp_charts_dir):
    ...
    f.create_chart('app-with-suffix', '3.6.9-suse-observability.8', local_deps=['common'])
...
'''
        ...
        assert fixtures.get_dependency_version('multi-local-deps', 'library-a') == '1.2.3'
...
'''
        ...
        assert fixtures.get_dependency_version('app-transitive', 'app-simple') == '1.0.1'
...
'''
        ...
        assert fixtures.get_dependency_version('remote-and-local-deps', 'common') == '0.4.28'
        # external-chart should NOT be updated
        assert fixtures.get_dependency_version('remote-and-local-deps', 'external-chart') == '2.0.0'
...
'''
        ...
        assert fixtures.get_dependency_version('kafka-like', 'suse-observability-sizing') == '0.1.3'
