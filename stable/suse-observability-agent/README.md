...
Current chart version is `1.3.13`
...
| checksAgent.image.tag | string | `"fc5e0b46"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"fc5e0b46"` | Default container image tag. |
...
| httpHeaderInjectorWebhook.certificatePrehook.image.tag | string | `"1.8.6-ea7f41f9-main-40"` |  |
...
| nodeAgent.containers.agent.image.tag | string | `"fc5e0b46"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"dc73c390"` | Default process-agent container image tag. |
