...
|------------|------|---------|
| https://helm.stackstate.io | httpHeaderInjectorWebhook(http-header-injector) | 0.0.12 |
...
| nodeAgent.containers.processAgent.image.tag | string | `"09afd849"` | Default process-agent container image tag. |
