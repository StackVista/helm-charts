...
Current chart version is `1.2.4`
...
| checksAgent.image.tag | string | `"18201ccd"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"18201ccd"` | Default container image tag. |
...
| httpHeaderInjectorWebhook.certificatePrehook.image.tag | string | `"1.8.0-bci"` |  |
...
| nodeAgent.containers.agent.image.tag | string | `"18201ccd"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"644a2640"` | Default process-agent container image tag. |
