...
| checksAgent.image.tag | string | `"4ea79f19"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"4ea79f19"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"4ea79f19"` | Default container image tag. |
