...
| checksAgent.image.tag | string | `"d0a7cf29"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"d0a7cf29"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"d0a7cf29"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"2e029b83"` | Default process-agent container image tag. |
