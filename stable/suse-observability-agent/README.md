...
| checksAgent.image.tag | string | `"6943bf8c"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"6943bf8c"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"6943bf8c"` | Default container image tag. |
