...
Current chart version is `1.5.18`
...
| checksAgent.image.tag | string | `"f66fba81"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"f66fba81"` | Default container image tag. |
...
| httpHeaderInjectorWebhook.certificatePrehook.image.tag | string | `"1.8.6-so13"` |  |
...
| httpHeaderInjectorWebhook.sidecarInjector.image.tag | string | `"15e759aa-1010-release"` |  |
...
| logsAgent.image.tag | string | `"3.6.11-so7"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"f66fba81"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"2f7e7bca"` | Default process-agent container image tag. |
