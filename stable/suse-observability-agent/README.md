...
Current chart version is `1.0.50`
...
| checksAgent.image.tag | string | `"53a03c5a"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"53a03c5a"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"53a03c5a"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"da72a056"` | Default process-agent container image tag. |
