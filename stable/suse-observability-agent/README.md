...
Current chart version is `1.0.61`
...
| checksAgent.image.tag | string | `"d4c5dbfe"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"d4c5dbfe"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"d4c5dbfe"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"ef001096"` | Default process-agent container image tag. |
