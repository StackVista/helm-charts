...
Current chart version is `1.2.24`
...
| checksAgent.image.tag | string | `"58971bde"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"58971bde"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"58971bde"` | Default container image tag. |
