...
| checksAgent.image.tag | string | `"bc305005"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"bc305005"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"bc305005"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"a7c2bdce"` | Default process-agent container image tag. |
