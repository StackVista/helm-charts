...
| checksAgent.image.tag | string | `"8a5bf777"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"8a5bf777"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"8a5bf777"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"e7a68fed"` | Default process-agent container image tag. |
