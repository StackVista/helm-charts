...
| checksAgent.image.tag | string | `"bad4a862"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"bad4a862"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"bad4a862"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"a8395131"` | Default process-agent container image tag. |
