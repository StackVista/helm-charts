...
| checksAgent.image.tag | string | `"62594359"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"62594359"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"62594359"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"a964a0c5"` | Default process-agent container image tag. |
