...
| checksAgent.image.tag | string | `"18c9e456"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"18c9e456"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"18c9e456"` | Default container image tag. |
