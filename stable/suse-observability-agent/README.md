...
Current chart version is `1.0.56`
...
| checksAgent.image.tag | string | `"a2f4d43a"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"a2f4d43a"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"a2f4d43a"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"6737762f"` | Default process-agent container image tag. |
