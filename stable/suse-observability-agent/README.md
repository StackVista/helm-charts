...
| checksAgent.image.tag | string | `"f09f66c8"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"f09f66c8"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"f09f66c8"` | Default container image tag. |
