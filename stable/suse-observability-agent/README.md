...
Current chart version is `1.5.25`
...
| checksAgent.image.tag | string | `"3e493962"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"3e493962"` | Default container image tag. |
...
| httpHeaderInjectorWebhook.sidecarInjector.image.tag | string | `"5e51c7f9-1013-release"` |  |
...
| nodeAgent.containers.agent.image.tag | string | `"3e493962"` | Default container image tag. |
