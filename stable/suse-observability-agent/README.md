...
Current chart version is `1.2.14`
...
| checksAgent.image.tag | string | `"3b4184c2"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"3b4184c2"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"3b4184c2"` | Default container image tag. |
