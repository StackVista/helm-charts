...
Current chart version is `1.0.62`
...
| checksAgent.image.tag | string | `"16c3f31c"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"16c3f31c"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"16c3f31c"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"8343e700"` | Default process-agent container image tag. |
