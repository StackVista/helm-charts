...
Current chart version is `1.3.28`
...
| checksAgent.image.tag | string | `"bedd24d7"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"bedd24d7"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"bedd24d7"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"1d628f0e"` | Default process-agent container image tag. |
