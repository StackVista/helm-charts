...
Current chart version is `1.0.75`
...
| checksAgent.image.tag | string | `"316e9f69"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"316e9f69"` | Default container image tag. |
...
| httpHeaderInjectorWebhook.certificatePrehook.image.tag | string | `"1.7.0"` |  |
...
| nodeAgent.containers.agent.image.tag | string | `"316e9f69"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"e78f39f3"` | Default process-agent container image tag. |
