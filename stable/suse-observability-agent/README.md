...
Current chart version is `1.2.10`
...
| checksAgent.image.tag | string | `"ab709837"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"ab709837"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"ab709837"` | Default container image tag. |
