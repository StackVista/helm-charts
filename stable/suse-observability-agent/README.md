...
| checksAgent.image.tag | string | `"13451dce"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"13451dce"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"13451dce"` | Default container image tag. |
