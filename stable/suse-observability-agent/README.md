...
Current chart version is `1.5.2`
...
| logsAgent.image.tag | string | `"3.6.11-so2"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"a56e2a32"` | Default process-agent container image tag. |
