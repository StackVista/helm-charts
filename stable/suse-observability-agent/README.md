...
Current chart version is `1.3.19`
...
| checksAgent.image.tag | string | `"8f254dcf"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"8f254dcf"` | Default container image tag. |
...
| kubernetes-rbac-agent.containers.rbacAgent.image.tag | string | `"e78c10a7-728-release"` |  |
...
| nodeAgent.containers.agent.image.tag | string | `"8f254dcf"` | Default container image tag. |
