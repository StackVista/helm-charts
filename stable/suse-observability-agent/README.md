...
Current chart version is `1.0.59`
...
| checksAgent.image.tag | string | `"3cd63aff"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"3cd63aff"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"3cd63aff"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"5748d9a9"` | Default process-agent container image tag. |
