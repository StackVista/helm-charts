...
Current chart version is `1.2.13`
...
| checksAgent.image.tag | string | `"abb957fa"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"abb957fa"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"abb957fa"` | Default container image tag. |
