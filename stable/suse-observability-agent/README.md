...
Current chart version is `1.2.31`
...
| checksAgent.image.tag | string | `"c93df31a"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"c93df31a"` | Default container image tag. |
...
| httpHeaderInjectorWebhook.certificatePrehook.image.tag | string | `"1.8.4-644"` |  |
...
| nodeAgent.containers.agent.image.tag | string | `"c93df31a"` | Default container image tag. |
