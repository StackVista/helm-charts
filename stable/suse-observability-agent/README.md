...
Current chart version is `1.3.39`
...
| checksAgent.image.tag | string | `"fc58e9ec"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"fc58e9ec"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"fc58e9ec"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"e504bc51"` | Default process-agent container image tag. |
