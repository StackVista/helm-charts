...
Current chart version is `1.0.46`
...
| checksAgent.image.tag | string | `"3f2d6658"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"3f2d6658"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"3f2d6658"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"af875378"` | Default process-agent container image tag. |
