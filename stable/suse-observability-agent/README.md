...
| checksAgent.image.tag | string | `"8be54df8"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"8be54df8"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"8be54df8"` | Default container image tag. |
