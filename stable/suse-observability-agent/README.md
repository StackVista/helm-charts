...
Current chart version is `1.2.26`
...
| checksAgent.image.tag | string | `"17f32f66"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"17f32f66"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"17f32f66"` | Default container image tag. |
