...
| checksAgent.image.tag | string | `"c4737ec1"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"c4737ec1"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"c4737ec1"` | Default container image tag. |
