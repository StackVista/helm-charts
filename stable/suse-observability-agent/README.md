...
|------------|------|---------|
| https://helm.stackstate.io | httpHeaderInjectorWebhook(http-header-injector) | 0.0.13 |
...
| checksAgent.image.tag | string | `"7d8d92af"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"7d8d92af"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"7d8d92af"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"916c1b9a"` | Default process-agent container image tag. |
