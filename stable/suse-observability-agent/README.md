...
| checksAgent.image.tag | string | `"39a6fbd0"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"39a6fbd0"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"39a6fbd0"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"b828a1cf"` | Default process-agent container image tag. |
