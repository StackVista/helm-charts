...
Current chart version is `1.0.45`
...
| checksAgent.image.tag | string | `"9eb19591"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"9eb19591"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"9eb19591"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"f63bb9b3"` | Default process-agent container image tag. |
