...
| https://helm.stackstate.io | httpHeaderInjectorWebhook(http-header-injector) | 0.0.27 |
...
| checksAgent.image.tag | string | `"17713a0b"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"17713a0b"` | Default container image tag. |
...
| httpHeaderInjectorWebhook.certificatePrehook.image.tag | string | `"1.8.6-fa52bb17-main-4"` |  |
...
| nodeAgent.containers.agent.image.tag | string | `"17713a0b"` | Default container image tag. |
