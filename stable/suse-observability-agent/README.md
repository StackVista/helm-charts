...
| checksAgent.image.tag | string | `"44f1b9fc"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"44f1b9fc"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"44f1b9fc"` | Default container image tag. |
