...
Current chart version is `1.6.10`
...
| httpHeaderInjectorWebhook.certificatePrehook.image.tag | string | `"1.8.6-so26"` |  |
...
| httpHeaderInjectorWebhook.proxyInit.image.tag | string | `"1.0.0-so7"` |  |
