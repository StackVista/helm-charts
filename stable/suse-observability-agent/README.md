...
| checksAgent.image.tag | string | `"1d75618d"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"1d75618d"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"1d75618d"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"8cc5830e"` | Default process-agent container image tag. |
