...
| checksAgent.image.tag | string | `"94dbcaae"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"94dbcaae"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"94dbcaae"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"956e8691"` | Default process-agent container image tag. |
