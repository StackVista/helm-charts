...
Current chart version is `1.2.5`
...
| checksAgent.image.tag | string | `"30644571"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"30644571"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"30644571"` | Default container image tag. |
