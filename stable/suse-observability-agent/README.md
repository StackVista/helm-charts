...
Current chart version is `1.6.5`
...
| otel.prometheusScraping.targetAllocator.image.tag | string | `"0.153.0-so12"` | SUSE Observability Target Allocator image tag (<upstream-version>-so<release-increment>). |
