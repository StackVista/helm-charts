...
| checksAgent.image.tag | string | `"13b6bde5"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"13b6bde5"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"13b6bde5"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"2beb529d"` | Default process-agent container image tag. |
