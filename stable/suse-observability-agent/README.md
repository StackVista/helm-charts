...
| checksAgent.image.tag | string | `"3b76bf33"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"3b76bf33"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"3b76bf33"` | Default container image tag. |
