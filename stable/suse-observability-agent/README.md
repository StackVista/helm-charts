...
| checksAgent.image.tag | string | `"60de960a"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"60de960a"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"60de960a"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"418f3d6d"` | Default process-agent container image tag. |
