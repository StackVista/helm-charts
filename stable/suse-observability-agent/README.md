...
| checksAgent.image.tag | string | `"04ca74ad"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"04ca74ad"` | Default container image tag. |
...
| httpHeaderInjectorWebhook.sidecarInjector.image.tag | string | `"5e51c7f9-1012-release"` |  |
...
| nodeAgent.containers.agent.image.tag | string | `"04ca74ad"` | Default container image tag. |
