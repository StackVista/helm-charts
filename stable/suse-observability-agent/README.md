...
| checksAgent.image.tag | string | `"d99efc04"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"d99efc04"` | Default container image tag. |
...
| httpHeaderInjectorWebhook.certificatePrehook.image.tag | string | `"1.8.6-so24"` |  |
...
| logsAgent.image.tag | string | `"3.6.11-so17"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"d99efc04"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"c028f242"` | Default process-agent container image tag. |
