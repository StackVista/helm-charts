...
| checksAgent.image.tag | string | `"e2eb8d36"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"e2eb8d36"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"e2eb8d36"` | Default container image tag. |
