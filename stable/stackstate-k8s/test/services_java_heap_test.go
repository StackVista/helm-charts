...
func TestServerJavaHeapRender(t *testing.T) {
	...
	expectedDeployments["stackstate-k8s-kafka2prom-0"] = v1.EnvVar{Name: "JAVA_OPTS", Value: "-XX:MaxDirectMemorySize=387m -Xmx387m -Xms387m"}
	expectedDeployments["stackstate-k8s-kafka2prom-1"] = v1.EnvVar{Name: "JAVA_OPTS", Value: "-XX:MaxDirectMemorySize=387m -Xmx387m -Xms387m"}
