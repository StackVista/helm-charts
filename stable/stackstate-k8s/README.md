...
Current chart version is `1.11.1-pre.40`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240805075403-master-5f08fce"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240801113050-master-02e1af9-selfhosted"` | Tag used for the `stackpacks` Docker image; |
