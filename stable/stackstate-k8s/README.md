...
Current chart version is `1.6.2-pre.18`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231218092118-master-011f79c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
