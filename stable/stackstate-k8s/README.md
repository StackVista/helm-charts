...
Current chart version is `1.6.2-pre.45`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231229143612-master-2aa3735"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
