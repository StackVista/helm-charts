...
Current chart version is `1.10.1-pre.66`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240513140624-master-215512a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
