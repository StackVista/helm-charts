...
Current chart version is `1.5.1-pre.12`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231206145055-master-e9b6910"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20231205134147-master-9b148fa-selfhosted"` | Tag used for the `stackpacks` Docker image; |
