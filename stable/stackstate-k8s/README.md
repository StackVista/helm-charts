...
Current chart version is `1.6.2-pre.55`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240109122311-master-32e515b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240108111823-master-8adbbe2-selfhosted"` | Tag used for the `stackpacks` Docker image; |
