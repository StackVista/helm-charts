...
Current chart version is `1.6.2-pre.71`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240116105951-master-aa14bf6"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240116091951-master-0b9f97a-selfhosted"` | Tag used for the `stackpacks` Docker image; |
