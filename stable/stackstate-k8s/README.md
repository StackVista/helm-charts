...
Current chart version is `1.8.1-pre.44`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240308103957-master-7602097"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
