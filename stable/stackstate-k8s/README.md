...
Current chart version is `1.8.1-pre.38`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240307112700-master-088e9ab"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
