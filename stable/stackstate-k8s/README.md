...
Current chart version is `1.11.1-pre.29`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240801113059-master-ed71484"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240801090915-master-add53ec-selfhosted"` | Tag used for the `stackpacks` Docker image; |
