...
Current chart version is `1.7.1-pre.37`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240131123139-master-a8abc3a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240201084222-master-226eae6-selfhosted"` | Tag used for the `stackpacks` Docker image; |
