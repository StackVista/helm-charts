...
Current chart version is `1.10.1-pre.124`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240612090150-master-d6c90c5"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
