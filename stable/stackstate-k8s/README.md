...
Current chart version is `1.8.1-pre.19`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240229172417-master-92c53de"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240301092038-master-c35cb26-selfhosted"` | Tag used for the `stackpacks` Docker image; |
