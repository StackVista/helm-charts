...
Current chart version is `2.0.1-pre.4`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20240912093814-master-9a8840f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
