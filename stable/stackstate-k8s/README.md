...
Current chart version is `1.10.1-pre.47`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240430153536-master-e7d4c1d"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240430121009-master-5d81746-selfhosted"` | Tag used for the `stackpacks` Docker image; |
