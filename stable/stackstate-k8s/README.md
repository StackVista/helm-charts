...
Current chart version is `2.0.0-pre.27`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20240910094616-master-44dd639"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20240909142948-master-9f735ff"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
