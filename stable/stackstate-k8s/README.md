...
Current chart version is `1.10.1-pre.142`
...
| clickhouse.backup.scheduled.schedule | string | `"45 0 * * *"` | Cron schedule for automatic backups of ClickHouse |
...
| stackstate.stackpacks.image.tag | string | `"20240614085436-master-236f7a9-selfhosted"` | Tag used for the `stackpacks` Docker image; |
