...
Current chart version is `1.6.2-pre.68`
...
| stackstate.stackpacks.image.tag | string | `"20240115155740-master-51415d0-saas"` | Tag used for the `stackpacks` Docker image; |
