...
Current chart version is `1.11.3-pre.5`
...
| stackstate.stackpacks.image.tag | string | `"20240807101245-master-8c4bf8a-selfhosted"` | Tag used for the `stackpacks` Docker image; |
