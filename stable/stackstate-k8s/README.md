...
Current chart version is `1.9.2-pre.7`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240402071908-master-d73eb4d"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
