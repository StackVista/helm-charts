...
Current chart version is `1.6.2-pre.32`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231221135033-master-1e2aac4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
