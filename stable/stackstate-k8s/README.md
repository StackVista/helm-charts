...
Current chart version is `1.10.1-pre.232`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240718162703-master-bc190af"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
