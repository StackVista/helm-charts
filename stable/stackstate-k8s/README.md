...
Current chart version is `1.10.1-pre.172`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240627071008-master-3fb1c55"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
