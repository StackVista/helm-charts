...
Current chart version is `1.10.1-pre.45`
...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-snapshot.137 |
...
| hbase.stackgraph.version | string | `"7.3.0"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240430110323-master-9fc3e76-2.5"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.components.containerTools.image.tag | string | `"1.3.0"` | Container image tag for container-tools containers. |
...
| stackstate.stackpacks.image.tag | string | `"20240430115555-master-42d90c1-selfhosted"` | Tag used for the `stackpacks` Docker image; |
