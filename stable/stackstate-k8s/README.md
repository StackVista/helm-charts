...
Current chart version is `1.10.1-pre.88`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240528110222-master-638d21a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
