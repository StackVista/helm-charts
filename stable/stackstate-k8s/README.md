...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240313090600-master-86a314b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240312164250-master-220341a-selfhosted"` | Tag used for the `stackpacks` Docker image; |
