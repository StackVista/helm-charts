...
Current chart version is `1.8.1-pre.65`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240314110905-master-88196ae"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240313095421-master-ca41cc4-selfhosted"` | Tag used for the `stackpacks` Docker image; |
