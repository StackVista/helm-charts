...
Current chart version is `1.7.1-pre.87`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240220074939-master-0d097af"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240220080036-master-67a4f27-selfhosted"` | Tag used for the `stackpacks` Docker image; |
