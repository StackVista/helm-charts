...
Current chart version is `1.10.1-pre.100`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240604082351-master-699b3e6"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
