...
Current chart version is `1.10.1-pre.238`
...
| hbase.stackgraph.version | string | `"7.6.7"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240722105901-master-5f67b6c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
