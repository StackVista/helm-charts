...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240315121703-master-2225de8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240315105709-master-2b9e71d-selfhosted"` | Tag used for the `stackpacks` Docker image; |
