...
Current chart version is `1.11.3-pre.1`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240806150819-master-716b65e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
