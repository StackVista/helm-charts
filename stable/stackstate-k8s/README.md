...
Current chart version is `1.9.3-pre.11`
...
| hbase.stackgraph.image.tag | string | `"5.0.1"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240408150309-master-72808c5"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
