...
Current chart version is `1.9.3-pre.2`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240405074729-master-0a14e04"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240405065113-master-c0625b3-selfhosted"` | Tag used for the `stackpacks` Docker image; |
