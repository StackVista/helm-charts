...
Current chart version is `1.11.1-pre.28`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240801100316-master-a619bae"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
