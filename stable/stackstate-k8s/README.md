...
Current chart version is `1.11.4-pre.18`
...
| stackstate.stackpacks.image.version | string | `"20240827072455-master-be0fd33"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
