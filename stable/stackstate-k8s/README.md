...
Current chart version is `1.7.1-pre.90`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240220104614-master-379d5c4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
