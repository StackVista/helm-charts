...
Current chart version is `1.10.1-pre.101`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240604085229-master-2a8bfcf"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240531132141-master-71bcee9-selfhosted"` | Tag used for the `stackpacks` Docker image; |
