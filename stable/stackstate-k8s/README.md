...
Current chart version is `1.10.1-pre.159`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240619153454-master-2a92f6a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240619111022-master-479559a-selfhosted"` | Tag used for the `stackpacks` Docker image; |
