...
Current chart version is `1.7.1-pre.78`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240215121159-master-7c4736a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
