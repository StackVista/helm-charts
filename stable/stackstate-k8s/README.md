...
Current chart version is `1.11.1-pre.8`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240724135942-master-ff8c5ae"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
