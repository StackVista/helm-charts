...
Current chart version is `1.7.1-pre.93`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240221121258-master-02291dc"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
