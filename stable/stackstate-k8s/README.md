...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240312145954-master-9db74ec"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240312154110-master-eed4413-selfhosted"` | Tag used for the `stackpacks` Docker image; |
