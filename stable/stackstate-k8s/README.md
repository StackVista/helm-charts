...
Current chart version is `1.8.1-pre.75`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240320102756-master-b198867"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
