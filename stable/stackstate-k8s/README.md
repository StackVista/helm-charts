...
| stackstate.stackpacks.image.version | string | `"20240902071204-master-3f3b27d"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
