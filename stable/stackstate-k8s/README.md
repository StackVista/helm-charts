...
Current chart version is `1.7.1-pre.30`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240130075512-master-26ca877"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240129123635-master-3c97262-selfhosted"` | Tag used for the `stackpacks` Docker image; |
