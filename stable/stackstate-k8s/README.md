...
Current chart version is `1.7.1-pre.26`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240125141102-master-1577505"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240126141520-master-a77eab1-selfhosted"` | Tag used for the `stackpacks` Docker image; |
