...
Current chart version is `1.7.1-pre.53`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240206191518-master-4cb0ec4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
