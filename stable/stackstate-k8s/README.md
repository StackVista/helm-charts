...
Current chart version is `1.7.1-pre.43`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240201150352-master-ff0e17d"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
