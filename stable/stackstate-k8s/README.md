...
| stackstate.components.correlate.resources | object | `{"limits":{"cpu":"2","ephemeral-storage":"1Gi","memory":"1800Mi"},"requests":{"cpu":"2","ephemeral-storage":"1Mi","memory":"1800Mi"}}` | Resource allocation for `correlate` pods. |
