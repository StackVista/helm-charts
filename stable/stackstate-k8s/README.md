...
Current chart version is `1.12.0`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20241011074340-stackstate-6.x-6fce897"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
