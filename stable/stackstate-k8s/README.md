...
Current chart version is `1.9.1-pre.10`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240328085140-master-9d0f85c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240327152858-master-bb659df-selfhosted"` | Tag used for the `stackpacks` Docker image; |
