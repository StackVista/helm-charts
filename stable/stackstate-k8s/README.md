...
Current chart version is `1.10.1-pre.127`
...
| stackstate.stackpacks.image.tag | string | `"20240612132530-master-2e40d2f-selfhosted"` | Tag used for the `stackpacks` Docker image; |
