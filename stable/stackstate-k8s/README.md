...
Current chart version is `1.6.2-pre.48`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240103112401-master-e3bcae5"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
