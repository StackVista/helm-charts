...
Current chart version is `1.10.1-pre.94`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240531132137-master-097d24e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
