...
Current chart version is `1.7.1-pre.71`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240214092307-master-95b112e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240214091047-master-db879d4-selfhosted"` | Tag used for the `stackpacks` Docker image; |
