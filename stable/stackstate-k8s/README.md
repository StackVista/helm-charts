...
Current chart version is `1.10.1-pre.162`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240620125710-master-52c9f14"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
