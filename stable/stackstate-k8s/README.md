...
Current chart version is `1.8.1-pre.55`
...
| stackstate.stackpacks.image.tag | string | `"20240311180830-master-d40dab9-selfhosted"` | Tag used for the `stackpacks` Docker image; |
