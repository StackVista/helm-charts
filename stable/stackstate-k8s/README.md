...
Current chart version is `1.7.1-pre.12`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240119143607-master-a8004e0"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
