...
Current chart version is `1.7.1-pre.22`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240125130906-master-4b2da6b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240125131723-master-2e8df7e-selfhosted"` | Tag used for the `stackpacks` Docker image; |
