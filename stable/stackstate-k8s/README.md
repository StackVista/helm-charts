...
Current chart version is `1.7.1-pre.36`
...
| stackstate.stackpacks.image.tag | string | `"20240131101350-master-de5c7bb-selfhosted"` | Tag used for the `stackpacks` Docker image; |
