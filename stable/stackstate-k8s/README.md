...
Current chart version is `1.6.2-pre.24`
...
|------------|------|---------|
| file://../common/ | common | * |
| file://../elasticsearch/ | elasticsearch | 8.5.1-stackstate.3 |
| file://../hbase/ | hbase | 0.1.166 |
...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-snapshot.96 |
...
| hbase.stackgraph.image.tag | string | `"4.14.0"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231220103837-master-bda2e33"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20231218142002-master-7b5b7a9-selfhosted"` | Tag used for the `stackpacks` Docker image; |
...
| zookeeper.image.tag | string | `"3.6.3-11a7319d"` | ZooKeeper image tag |
