...
Current chart version is `1.10.1-pre.102`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240604122417-master-1a7f9ab"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
