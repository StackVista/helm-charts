...
Current chart version is `1.11.4-pre.23`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240828070446-master-6716ce1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
