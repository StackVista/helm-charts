...
Current chart version is `1.10.1-pre.15`
...
| stackstate.stackpacks.image.tag | string | `"20240412142302-master-d7206e3-selfhosted"` | Tag used for the `stackpacks` Docker image; |
