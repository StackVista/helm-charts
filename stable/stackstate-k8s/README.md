...
Current chart version is `1.10.1-pre.239`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240723073127-master-3cd29e8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
