...
Current chart version is `1.2.1-pre.3`
...
| hbase.stackgraph.image.tag | string | `"4.13.0"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.stackpacks.image | object | `{"pullPolicy":"","registry":"quay.io","repository":"stackstate/stackpacks","tag":"20231006103928-master-ab49f65-selfhosted"}` | Docker image to use as source for stackpacks. |
...
| stackstate.stackpacks.image.tag | string | `"20231006103928-master-ab49f65-selfhosted"` | Tag used for the `stackpacks` Docker image; |
