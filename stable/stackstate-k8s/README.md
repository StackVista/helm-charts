...
Current chart version is `1.7.1-pre.54`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240207133756-master-4df1366"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
