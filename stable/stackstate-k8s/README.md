...
Current chart version is `1.8.1-pre.63`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240312112851-master-b7f43fe"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240312110115-master-bae3ede-selfhosted"` | Tag used for the `stackpacks` Docker image; |
