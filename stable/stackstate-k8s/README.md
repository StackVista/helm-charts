...
Current chart version is `1.7.1-pre.15`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240123152353-master-4810bbd"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240122133046-master-206cc79-selfhosted"` | Tag used for the `stackpacks` Docker image; |
