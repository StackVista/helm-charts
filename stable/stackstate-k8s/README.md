...
Current chart version is `1.8.1-pre.72`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240320090017-master-55dbb3c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
