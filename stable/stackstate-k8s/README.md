...
Current chart version is `1.8.1-pre.58`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240312070816-master-cc17b7f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240312082514-master-cb47392-selfhosted"` | Tag used for the `stackpacks` Docker image; |
