...
Current chart version is `1.7.1-pre.95`
...
| stackstate.stackpacks.image.tag | string | `"20240220095302-master-962fb8e-selfhosted"` | Tag used for the `stackpacks` Docker image; |
