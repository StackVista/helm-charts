...
Current chart version is `1.10.1-pre.151`
...
| hbase.stackgraph.version | string | `"7.5.0"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240617191542-master-5b9af1e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
