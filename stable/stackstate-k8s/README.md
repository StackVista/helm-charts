...
Current chart version is `1.10.1-pre.193`
...
| stackstate.stackpacks.image.tag | string | `"20240703095327-master-055572f-selfhosted"` | Tag used for the `stackpacks` Docker image; |
