...
Current chart version is `1.6.2-pre.17`
...
| stackstate.stackpacks.image.tag | string | `"20231218125242-master-64f90ad-selfhosted"` | Tag used for the `stackpacks` Docker image; |
