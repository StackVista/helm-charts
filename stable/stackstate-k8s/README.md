...
Current chart version is `1.10.1-pre.130`
...
| stackstate.stackpacks.image.tag | string | `"20240612162227-master-89cd822-selfhosted"` | Tag used for the `stackpacks` Docker image; |
