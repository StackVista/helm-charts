...
Current chart version is `1.11.2-pre.3`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240806125238-master-b561cbd"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
