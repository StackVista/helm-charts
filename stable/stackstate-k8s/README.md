...
Current chart version is `1.10.1-pre.128`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240612113957-master-c13517b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240612151305-master-4e14979-selfhosted"` | Tag used for the `stackpacks` Docker image; |
