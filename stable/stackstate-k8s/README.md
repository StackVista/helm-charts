...
Current chart version is `1.9.2-pre.6`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240328125815-master-20ccb1e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
