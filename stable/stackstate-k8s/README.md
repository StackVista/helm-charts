...
Current chart version is `1.6.2-pre.60`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240112084814-master-95d208c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
