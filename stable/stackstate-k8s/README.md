...
Current chart version is `1.11.3-pre.16`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240813081305-master-59caa01"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
