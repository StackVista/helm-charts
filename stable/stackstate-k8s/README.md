...
Current chart version is `1.9.1-pre.6`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240327135215-master-22efa25"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240326082139-master-7195f98-selfhosted"` | Tag used for the `stackpacks` Docker image; |
