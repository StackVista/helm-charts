...
Current chart version is `1.10.1-pre.53`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240502133344-master-0749a73"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
