...
Current chart version is `1.11.1-pre.25`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240730192208-master-55fada8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
