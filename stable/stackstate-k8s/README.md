...
Current chart version is `1.8.1-pre.28`
...
| stackstate.stackpacks.image.tag | string | `"20240305081108-master-2ae96da-selfhosted"` | Tag used for the `stackpacks` Docker image; |
