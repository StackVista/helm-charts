...
Current chart version is `1.10.1-pre.74`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240516115841-master-bbc094c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240516124339-master-a80de8b-selfhosted"` | Tag used for the `stackpacks` Docker image; |
