...
Current chart version is `1.10.1-pre.206`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240709071133-master-8d9e3ee"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
