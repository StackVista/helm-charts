...
Current chart version is `1.11.1-pre.13`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240726113328-master-a24a5f4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240724065538-master-db9caea-selfhosted"` | Tag used for the `stackpacks` Docker image; |
