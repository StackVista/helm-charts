...
Current chart version is `1.7.1-pre.11`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240119125712-master-0a71e6d"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
