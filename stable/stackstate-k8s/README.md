...
Current chart version is `1.8.1-pre.32`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240305144640-master-8c00365"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240305112347-master-da985b6-selfhosted"` | Tag used for the `stackpacks` Docker image; |
