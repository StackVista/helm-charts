...
Current chart version is `1.7.1-pre.73`
...
| stackstate.stackpacks.image.tag | string | `"20240214095204-master-19699c5-selfhosted"` | Tag used for the `stackpacks` Docker image; |
