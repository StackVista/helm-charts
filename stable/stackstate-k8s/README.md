...
Current chart version is `1.11.1-pre.23`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240730132931-master-2d44090"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240729072712-master-b687c34-selfhosted"` | Tag used for the `stackpacks` Docker image; |
