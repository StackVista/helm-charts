...
Current chart version is `1.9.3-pre.18`
...
| hbase.stackgraph.image.tag | string | `"7.0.0"` | The StackGraph server version, must be compatible with the StackState version |
