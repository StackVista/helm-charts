...
Current chart version is `1.10.1-pre.146`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240617113924-master-2c8d4e3"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
