...
Current chart version is `1.10.1-pre.144`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240614150929-master-4bb3f0c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240614122401-master-f38ad85-selfhosted"` | Tag used for the `stackpacks` Docker image; |
