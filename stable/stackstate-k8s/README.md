...
Current chart version is `1.0.6-snapshot.4`
...
| stackstate.components.containerTools.image.tag | string | `"1.1.8"` | Container image tag for container-tools containers. |
