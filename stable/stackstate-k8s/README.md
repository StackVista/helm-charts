...
Current chart version is `1.10.1-pre.185`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240702091353-master-7bf621a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240701151041-master-9ae2449-selfhosted"` | Tag used for the `stackpacks` Docker image; |
