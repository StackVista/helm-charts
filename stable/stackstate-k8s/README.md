...
Current chart version is `1.10.1-pre.22`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240418113145-master-c5fde1b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
