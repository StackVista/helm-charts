...
Current chart version is `1.0.6-snapshot.5`
...
| file://../victoria-metrics/victoria-metrics-single/ | victoria-metrics-0(victoria-metrics-single) | 0.8.53-stackstate.1 |
| file://../victoria-metrics/victoria-metrics-single/ | victoria-metrics-1(victoria-metrics-single) | 0.8.53-stackstate.1 |
| https://helm.stackstate.io | anomaly-detection | 5.2.0-snapshot.76 |
...
| hbase.stackgraph.image.tag | string | `"4.12.3"` | The StackGraph server version, must be compatible with the StackState version |
...
| kafka.metrics.jmx.image.tag | string | `"0.17.0-00153388"` | Kafka JMX exporter image tag |
...
| stackstate.components.all.image.tag | string | `"5.2.0-snapshot.20230818093907-master-ff2c570"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image | object | `{"pullPolicy":"","registry":"quay.io","repository":"stackstate/stackpacks","tag":"20230818073825-master-0f2fb1b-selfhosted"}` | Docker image to use as source for stackpacks. |
...
| stackstate.stackpacks.image.tag | string | `"20230818073825-master-0f2fb1b-selfhosted"` | Tag used for the `stackpacks` Docker image; |
