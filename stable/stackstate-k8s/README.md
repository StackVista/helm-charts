...
Current chart version is `1.8.1-pre.5`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240227115520-master-37d5fa0"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240227124327-master-be5714b-selfhosted"` | Tag used for the `stackpacks` Docker image; |
