...
| stackstate.stackpacks.image.version | string | `"20240814095550-master-169769e"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
