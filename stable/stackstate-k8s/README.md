...
Current chart version is `1.8.1-pre.23`
...
| stackstate.stackpacks.image.tag | string | `"20240304110022-master-17890bf-selfhosted"` | Tag used for the `stackpacks` Docker image; |
