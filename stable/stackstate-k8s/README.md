...
Current chart version is `1.7.1-pre.19`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240125115832-master-c3c6537"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240124084152-master-75cac60-selfhosted"` | Tag used for the `stackpacks` Docker image; |
