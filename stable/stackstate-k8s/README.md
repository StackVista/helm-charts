...
Current chart version is `1.6.2-pre.66`
...
| stackstate.stackpacks.image.tag | string | `"20240115152935-master-6cbd0a2-selfhosted"` | Tag used for the `stackpacks` Docker image; |
