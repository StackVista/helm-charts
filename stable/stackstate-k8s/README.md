...
Current chart version is `1.10.1-pre.34`
...
|------------|------|---------|
| file://../common/ | common | * |
| file://../elasticsearch/ | elasticsearch | 8.11.4-stackstate.1 |
...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-snapshot.127 |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240424215224-master-c3a7493"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
