...
Current chart version is `1.6.2-pre.67`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240115133336-master-7604ec5"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240115153513-master-fe81cbc-selfhosted"` | Tag used for the `stackpacks` Docker image; |
