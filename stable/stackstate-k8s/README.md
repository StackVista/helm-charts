...
Current chart version is `1.11.3-pre.10`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240808150810-master-2d0c822"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
