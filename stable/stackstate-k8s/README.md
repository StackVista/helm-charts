...
Current chart version is `2.0.0-pre.30`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20240910103137-master-9856983"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20240910151450-master-c4ea0b3"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
