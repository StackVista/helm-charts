...
Current chart version is `1.10.1-pre.203`
...
| hbase.stackgraph.version | string | `"7.6.2"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240704192226-master-d11a429"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
