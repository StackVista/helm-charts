...
Current chart version is `1.8.1-pre.3`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240227104707-master-d81c503"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240227104839-master-4f2f8fa-selfhosted"` | Tag used for the `stackpacks` Docker image; |
