...
Current chart version is `1.7.1-pre.70`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240214081115-master-55ff9d5"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240214080814-master-fbbc67c-selfhosted"` | Tag used for the `stackpacks` Docker image; |
