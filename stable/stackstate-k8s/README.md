...
Current chart version is `1.10.1-pre.13`
...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-snapshot.123 |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240412120113-master-f7d4e16"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
