...
Current chart version is `1.11.4-pre.5`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240821095112-master-fe2a582"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
