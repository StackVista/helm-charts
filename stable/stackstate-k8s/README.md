...
Current chart version is `1.9.2-pre.9`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240402131555-master-485026b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240328142007-master-8f4882b-selfhosted"` | Tag used for the `stackpacks` Docker image; |
