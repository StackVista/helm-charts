...
Current chart version is `1.10.1-pre.236`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240719170810-master-8a911a6"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
