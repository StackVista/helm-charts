...
Current chart version is `1.8.1-pre.15`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240229133416-master-0c36224"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240229140103-master-6ecc648-selfhosted"` | Tag used for the `stackpacks` Docker image; |
