...
Current chart version is `1.8.1-pre.14`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240228141852-master-a1fd315"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240227152241-master-bcd4059-selfhosted"` | Tag used for the `stackpacks` Docker image; |
