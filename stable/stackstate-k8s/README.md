...
Current chart version is `1.7.1-pre.104`
...
| stackstate.stackpacks.image.tag | string | `"20240223114046-master-465700d-selfhosted"` | Tag used for the `stackpacks` Docker image; |
