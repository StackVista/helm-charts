...
Current chart version is `1.8.1-pre.7`
...
| stackstate.stackpacks.image.tag | string | `"20240227134910-master-8142667-selfhosted"` | Tag used for the `stackpacks` Docker image; |
