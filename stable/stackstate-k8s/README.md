...
Current chart version is `1.4.1-pre.7`
...
| file://../victoria-metrics-single/ | victoria-metrics-0(victoria-metrics-single) | 0.8.53-stackstate.5 |
| file://../victoria-metrics-single/ | victoria-metrics-1(victoria-metrics-single) | 0.8.53-stackstate.5 |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231128155326-master-f7d05d8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
