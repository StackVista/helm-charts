...
Current chart version is `1.8.1-pre.68`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240319101634-master-0b93983"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
