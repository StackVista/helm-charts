...
Current chart version is `1.0.6-snapshot.8`
...
| hbase.stackgraph.image.tag | string | `"4.12.4"` | The StackGraph server version, must be compatible with the StackState version |
