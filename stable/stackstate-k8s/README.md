...
Current chart version is `1.9.3-pre.1`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240404153737-master-d7f2113"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240404140524-master-3dc7e3e-selfhosted"` | Tag used for the `stackpacks` Docker image; |
