...
Current chart version is `1.9.2-pre.4`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240328122641-master-1a1b722"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240328105701-master-b7b738a-selfhosted"` | Tag used for the `stackpacks` Docker image; |
