...
Current chart version is `1.8.1-pre.25`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240304161949-master-7b720bc"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240304163653-master-d9d0621-selfhosted"` | Tag used for the `stackpacks` Docker image; |
