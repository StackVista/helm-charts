...
Current chart version is `1.6.2-pre.42`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231228144226-master-81e111a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20231222171457-master-7e7c542-selfhosted"` | Tag used for the `stackpacks` Docker image; |
