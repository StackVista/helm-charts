...
Current chart version is `1.10.1-pre.137`
...
| stackstate.stackpacks.image.tag | string | `"20240613094747-master-8fc88a4-selfhosted"` | Tag used for the `stackpacks` Docker image; |
