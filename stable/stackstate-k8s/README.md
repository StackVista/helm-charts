...
Current chart version is `1.7.1-pre.60`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240209081700-master-7eefcc8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240206125323-master-e1bce6f-selfhosted"` | Tag used for the `stackpacks` Docker image; |
