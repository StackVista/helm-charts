...
Current chart version is `1.10.1-pre.79`
...
| stackstate.stackpacks.image.tag | string | `"20240516130314-master-b8b54b5-selfhosted"` | Tag used for the `stackpacks` Docker image; |
