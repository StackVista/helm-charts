...
Current chart version is `1.7.1-pre.106`
...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-snapshot.102 |
...
| opentelemetry-collector.image.tag | string | `"v0.0.5"` | Container image tag for 'opentelemetry-collector' containers. |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240226082145-master-ac8c016"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240226144120-master-921702a-selfhosted"` | Tag used for the `stackpacks` Docker image; |
