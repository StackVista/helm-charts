...
Current chart version is `1.7.1-pre.59`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240208115242-master-fdd39b3"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
