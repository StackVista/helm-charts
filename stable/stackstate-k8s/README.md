...
Current chart version is `1.0.0-snapshot.1`
...
| stackstate.deployment | object | `{"mode":"SaaS"}` | Deployment settings for StackState |
| stackstate.deployment.mode | string | `"SaaS"` | Deployment mode of StackState, possible values are 'SaaS' and 'SelfHosted' |
