...
Current chart version is `1.10.1-pre.55`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240503121252-master-06ebff0"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
