...
Current chart version is `2.0.0-pre.32`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20240911112250-master-f9361e0"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
