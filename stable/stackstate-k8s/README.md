...
Current chart version is `1.6.2-pre.62`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240112161811-master-801e4a9"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240109150400-master-c1f380b-selfhosted"` | Tag used for the `stackpacks` Docker image; |
