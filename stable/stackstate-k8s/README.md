...
Current chart version is `1.8.1-pre.56`
...
| stackstate.stackpacks.image.tag | string | `"20240312075849-master-7db9fc6-selfhosted"` | Tag used for the `stackpacks` Docker image; |
