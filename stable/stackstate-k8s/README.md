...
Current chart version is `1.6.2-pre.37`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231222113733-master-4b991f2"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20231222093051-master-29af8a5-selfhosted"` | Tag used for the `stackpacks` Docker image; |
