...
Current chart version is `1.10.1-pre.120`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240611064816-master-71695d8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
