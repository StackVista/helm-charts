...
Current chart version is `1.10.1-pre.85`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240527131022-master-be4b02e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
