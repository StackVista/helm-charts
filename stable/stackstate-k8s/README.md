...
Current chart version is `1.8.1-pre.22`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240301155439-master-d4f0894"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240304094850-master-72e5749-selfhosted"` | Tag used for the `stackpacks` Docker image; |
