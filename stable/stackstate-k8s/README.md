...
Current chart version is `1.10.1-pre.20`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240417152005-master-76cb5ca"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
