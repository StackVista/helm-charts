...
Current chart version is `1.10.1-pre.138`
...
| stackstate.stackpacks.image.tag | string | `"20240613114240-master-b7f9c07-selfhosted"` | Tag used for the `stackpacks` Docker image; |
