...
Current chart version is `1.7.1-pre.44`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240202111947-master-b00345e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240201084614-master-910b43f-selfhosted"` | Tag used for the `stackpacks` Docker image; |
