...
Current chart version is `1.9.3-pre.9`
...
| stackstate.stackpacks.image.tag | string | `"20240408123035-master-420e788-selfhosted"` | Tag used for the `stackpacks` Docker image; |
