...
Current chart version is `1.10.1-pre.86`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240528074016-master-4d683dc"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
