...
Current chart version is `1.10.1-pre.92`
...
| stackstate.stackpacks.image.tag | string | `"20240530134339-master-ba7c945-selfhosted"` | Tag used for the `stackpacks` Docker image; |
