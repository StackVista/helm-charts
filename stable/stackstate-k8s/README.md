...
Current chart version is `1.10.1-pre.98`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240603115602-master-2184e6b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
