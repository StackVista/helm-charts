...
Current chart version is `1.11.4-pre.22`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240827143410-master-346c80c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
