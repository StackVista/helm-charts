...
Current chart version is `1.7.1-pre.68`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240213101934-master-711c9d1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240213103347-master-a1109e5-selfhosted"` | Tag used for the `stackpacks` Docker image; |
