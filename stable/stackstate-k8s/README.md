...
Current chart version is `1.7.1-pre.65`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240212145413-master-766bde1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240209094501-master-5ddcab2-selfhosted"` | Tag used for the `stackpacks` Docker image; |
