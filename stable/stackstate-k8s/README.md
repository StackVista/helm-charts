...
Current chart version is `1.6.2-pre.64`
...
| stackstate.stackpacks.image.tag | string | `"20240115144436-master-c2b128d-selfhosted"` | Tag used for the `stackpacks` Docker image; |
