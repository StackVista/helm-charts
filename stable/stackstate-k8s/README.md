...
Current chart version is `1.7.1-pre.96`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240222120949-master-87aed5a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
