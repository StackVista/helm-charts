...
Current chart version is `1.11.1-pre.32`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240801152215-master-5897512"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
