...
Current chart version is `1.0.6-snapshot.0`
...
| hbase.stackgraph.image.tag | string | `"4.12.1"` | The StackGraph server version, must be compatible with the StackState version |
