...
Current chart version is `1.10.1-pre.90`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240530131944-master-8a193c3"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240530124819-master-55753d8-selfhosted"` | Tag used for the `stackpacks` Docker image; |
