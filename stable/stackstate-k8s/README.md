...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-snapshot.108 |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240318131317-master-efed2f8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240315133521-master-c4e818f-selfhosted"` | Tag used for the `stackpacks` Docker image; |
