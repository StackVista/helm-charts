...
Current chart version is `1.6.2-pre.15`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231215142820-master-418d6cd"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
