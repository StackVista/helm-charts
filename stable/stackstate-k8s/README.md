...
Current chart version is `1.10.1-pre.155`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240619063603-master-7a18b0e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
