...
Current chart version is `1.9.1-pre.5`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240327100439-master-60747e7"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
