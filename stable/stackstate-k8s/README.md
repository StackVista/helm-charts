...
Current chart version is `1.7.1-pre.100`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240223152506-master-c1cd632"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240222152053-master-cd96c45-selfhosted"` | Tag used for the `stackpacks` Docker image; |
