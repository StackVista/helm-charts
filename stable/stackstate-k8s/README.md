...
Current chart version is `1.8.1-pre.43`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240308094109-master-600f291"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240308092405-master-1b23053-selfhosted"` | Tag used for the `stackpacks` Docker image; |
