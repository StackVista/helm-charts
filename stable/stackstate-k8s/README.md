...
Current chart version is `1.10.1-pre.180`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240628084837-master-78e0146"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240628094457-master-c394f33-selfhosted"` | Tag used for the `stackpacks` Docker image; |
