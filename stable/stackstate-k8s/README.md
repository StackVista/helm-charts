...
Current chart version is `1.8.1-pre.67`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240318155632-master-11ae010"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240319075329-master-5e31cb9-selfhosted"` | Tag used for the `stackpacks` Docker image; |
