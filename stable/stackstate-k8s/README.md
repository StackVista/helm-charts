...
Current chart version is `1.11.3-pre.3`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240807093016-master-0c9edf0"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
