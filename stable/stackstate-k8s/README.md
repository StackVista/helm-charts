...
Current chart version is `1.10.1-pre.205`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240708203653-master-61e0648"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
