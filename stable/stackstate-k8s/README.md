...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240312173331-master-1459b56"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240312155045-master-ada415e-selfhosted"` | Tag used for the `stackpacks` Docker image; |
