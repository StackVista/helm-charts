...
Current chart version is `1.10.1-pre.161`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240619181109-master-366102a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240619201101-master-b218ca3-selfhosted"` | Tag used for the `stackpacks` Docker image; |
