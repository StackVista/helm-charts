...
Current chart version is `1.6.2-pre.31`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231221123410-master-3bcb3d3"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20231221123148-master-9f98c85-selfhosted"` | Tag used for the `stackpacks` Docker image; |
