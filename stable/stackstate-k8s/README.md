...
Current chart version is `2.0.0-pre.23`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20240906175551-master-a6ee5a2"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20240906091920-master-1f25c46"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
