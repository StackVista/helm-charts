...
Current chart version is `1.8.1-pre.35`
...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-snapshot.106 |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240306082832-master-d4fb06e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240306142842-master-22ad19c-selfhosted"` | Tag used for the `stackpacks` Docker image; |
