...
Current chart version is `1.5.1-pre.13`
...
| minio.image.tag | string | `"RELEASE.2021-02-14T04-01-33Z-46e9b6c9"` |  |
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20231211113404-master-92a28ae"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20231212075607-master-b2f061f-selfhosted"` | Tag used for the `stackpacks` Docker image; |
