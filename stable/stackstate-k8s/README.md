...
Current chart version is `2.0.0-pre.24`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20240909070943-master-37d581b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
