...
Current chart version is `1.6.2-pre.52`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240105095139-master-c51d64d"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.tag | string | `"20240105153636-master-aca48bf-selfhosted"` | Tag used for the `stackpacks` Docker image; |
