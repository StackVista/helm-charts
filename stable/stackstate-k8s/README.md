...
Current chart version is `1.9.3-pre.16`
...
| stackstate.components.all.image.tag | string | `"6.0.0-snapshot.20240409090907-master-dfece27"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
