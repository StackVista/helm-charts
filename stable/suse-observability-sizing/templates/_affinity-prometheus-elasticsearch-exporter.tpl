{{/*
=============================================================================
Prometheus Elasticsearch Exporter Affinity Configuration
These templates provide complete affinity configurations for Prometheus Elasticsearch Exporter.
=============================================================================
*/}}

{{/*
Get complete Prometheus Elasticsearch Exporter affinity configuration for HA profiles.
...
prometheus-elasticsearch-exporter:
  affinity: {{ include "common.sizing.prometheus-elasticsearch-exporter.affinityConfig" . | nindent 4 }}
...
Returns (for HA profiles with nodeAffinity):
  ...
  podAntiAffinity:
    ...
    - labelSelector:
        matchLabels:
          app.kubernetes.io/component: prometheus-elasticsearch-exporter
      topologyKey: kubernetes.io/hostname
*/}}
{{- define "common.sizing.prometheus-elasticsearch-exporter.affinityConfig" -}}
{{- $result := dict -}}
...
{{- $podAntiAffinity := include "common.sizing.prometheus-elasticsearch-exporter.affinity" . | trim -}}
{{- if $podAntiAffinity -}}
