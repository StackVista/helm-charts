...
*/}}
{{- define "common.sizing.kubernetes-rbac-agent.affinity" -}}
{{- include "common.sizing.podAntiAffinity" (dict "labels" (dict "app.kubernetes.io/component" "kubernetes-rbac-agent") "context" .) }}
{{- end }}
