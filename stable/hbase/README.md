...
| hdfs.version | string | `"java21-8-5e4f83b"` | The hadoop version is automatically derived from the hbase version, this is the specific build version of the HDFS image for that version |
