...
Current chart version is `0.1.84`
...
| stackgraph.image.tag | string | `"4.1.7"` | The default tag used for all omponents of hbase that are stackgraph version dependent; invividual service `tag`s can be overriden (see below). |
