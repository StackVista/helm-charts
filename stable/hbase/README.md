...
Current chart version is `0.1.170`
...
| stackgraph.image.tag | string | `"5.0.1"` | The default tag used for all omponents of hbase that are stackgraph version dependent; invividual service `tag`s can be overriden (see below). |
