...
Current chart version is `0.2.141`
...
| hdfs.version | string | `"java21-9-e48c56d0-release-371"` | The hadoop version is automatically derived from the hbase version, this is the specific build version of the HDFS image for that version |
...
| stackgraph.version | string | `"7.14.5"` | Version of stackgraph to use |
