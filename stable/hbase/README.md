...
Current chart version is `0.2.144`
...
| hdfs.version | string | `"java21-9-656d8f62-amd64-379"` | The hadoop version is automatically derived from the hbase version, this is the specific build version of the HDFS image for that version |
