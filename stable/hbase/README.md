...
Current chart version is `0.1.165`
...
| hdfs.image.tag | string | `"2.10.2-java11-6-cc17c8c3"` | Default container image tag for HDFS datanode. |
...
| wait.image.tag | string | `"1.0.9-104f3090"` |  |
