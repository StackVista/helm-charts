...
Current chart version is `0.1.137`
...
| stackgraph.image.tag | string | `"4.7.1"` | The default tag used for all omponents of hbase that are stackgraph version dependent; invividual service `tag`s can be overriden (see below). |
