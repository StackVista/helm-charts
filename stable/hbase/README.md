...
Current chart version is `0.2.152`
...
| hdfs.version | string | `"java21-9-6ad43a75-amd64-390"` | The hadoop version is automatically derived from the hbase version, this is the specific build version of the HDFS image for that version |
...
| stackgraph.version | string | `"7.14.13"` | Version of stackgraph to use |
