...
Current chart version is `0.2.6-bram`
...
| hdfs.image.tag | string | `"6797359275-2.10.2-java11-6-6e17db2f"` | Default container image tag for HDFS datanode. |
...
| stackgraph.version | string | `"7.3.1"` | Version of stackgraph to use |
