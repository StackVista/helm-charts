...
Current chart version is `0.2.150`
...
| hdfs.version | string | `"java21-9-6cb836e0-amd64-386"` | The hadoop version is automatically derived from the hbase version, this is the specific build version of the HDFS image for that version |
...
| stackgraph.version | string | `"7.14.12"` | Version of stackgraph to use |
