...
Current chart version is `0.1.162`
...
| stackgraph.image.tag | string | `"4.13.0"` | The default tag used for all omponents of hbase that are stackgraph version dependent; invividual service `tag`s can be overriden (see below). |
