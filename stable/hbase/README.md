...
Current chart version is `0.1.171`
...
| stackgraph.image.tag | string | `"6.0.0"` | The default tag used for all omponents of hbase that are stackgraph version dependent; invividual service `tag`s can be overriden (see below). |
