...
Current chart version is `1.0.28`
...
| checksAgent.image.tag | string | `"252fb041"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"252fb041"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"252fb041"` | Default container image tag. |
