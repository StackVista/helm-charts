...
Current chart version is `1.0.17`
...
| checksAgent.image.tag | string | `"b10371b8"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"b10371b8"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"b10371b8"` | Default container image tag. |
