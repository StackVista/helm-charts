...
| checksAgent.image.tag | string | `"602a027b"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"602a027b"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"602a027b"` | Default container image tag. |
