...
Current chart version is `1.0.39`
...
| checksAgent.image.tag | string | `"73c18864"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"73c18864"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"73c18864"` | Default container image tag. |
