...
Current chart version is `1.0.15`
...
| checksAgent.image.tag | string | `"b4286a39"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"b4286a39"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"b4286a39"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"651945cb"` | Default process-agent container image tag. |
