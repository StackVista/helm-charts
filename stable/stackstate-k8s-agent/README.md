...
Current chart version is `1.0.24`
...
| checksAgent.image.tag | string | `"4a551fca"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"4a551fca"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"4a551fca"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"8ead9218"` | Default process-agent container image tag. |
