...
| checksAgent.image.tag | string | `"a43016a1"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"a43016a1"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"a43016a1"` | Default container image tag. |
