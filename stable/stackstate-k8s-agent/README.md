...
| checksAgent.image.tag | string | `"19b1e9ab"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"19b1e9ab"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"19b1e9ab"` | Default container image tag. |
