...
| checksAgent.image.tag | string | `"1df9198b"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"1df9198b"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"1df9198b"` | Default container image tag. |
