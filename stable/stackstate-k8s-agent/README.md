...
| checksAgent.image.tag | string | `"2f9a9c80"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"2f9a9c80"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"2f9a9c80"` | Default container image tag. |
