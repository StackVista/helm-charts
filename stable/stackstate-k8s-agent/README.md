...
Current chart version is `1.0.36`
...
| checksAgent.image.tag | string | `"8ce04a82"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"8ce04a82"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"8ce04a82"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"59e2cb56"` | Default process-agent container image tag. |
