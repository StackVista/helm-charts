...
Current chart version is `1.0.32`
...
| checksAgent.image.tag | string | `"8c806307"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"8c806307"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"8c806307"` | Default container image tag. |
