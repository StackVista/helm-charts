...
| checksAgent.image.tag | string | `"3d5675a7"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"3d5675a7"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"3d5675a7"` | Default container image tag. |
