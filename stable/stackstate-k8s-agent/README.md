...
Current chart version is `1.0.22`
...
| checksAgent.image.tag | string | `"96dc8b8d"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"96dc8b8d"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"96dc8b8d"` | Default container image tag. |
