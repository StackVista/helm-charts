...
| checksAgent.image.tag | string | `"2425caff"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"2425caff"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"2425caff"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"4ac1b0ea"` | Default process-agent container image tag. |
