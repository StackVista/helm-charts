...
Current chart version is `1.0.97`
...
| checksAgent.image.tag | string | `"e7570936"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"e7570936"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"e7570936"` | Default container image tag. |
...
| nodeAgent.containers.processAgent.image.tag | string | `"39782782"` | Default process-agent container image tag. |
