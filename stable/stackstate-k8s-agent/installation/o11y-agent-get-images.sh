...
function usage() {
  cat <<EOF >&2
Get the list of Docker images used by the Rancher Prime Observability Agent chart

Usage:
  $0 -f stackstate-k8s-agent-X.Y.Z.tgz

Arguments:
    -f : TGZ archive with the Rancher Prime Observability Agent chart (required)
