...
image_archive="o11y-agent-images.tar.gz"

function usage() {
  cat <<EOF
Load Docker images needed for the Rancher Prime Observability Agent chart to another Docker image registry

Usage:
  $0 -d custom-registry.example.com:5000 -i o11y-agent-images.txt -f o11y-agent-images.tar.gz
