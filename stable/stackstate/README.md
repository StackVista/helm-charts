...
Current chart version is `4.6.0-pre.1.rc.4`
...
| https://helm.stackstate.io | anomaly-detection | 4.6.0-pre.1.rc.4 |
...
| hbase.stackgraph.image.tag | string | `"4.6.0"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"4.6.0-pre.1.rc.4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
