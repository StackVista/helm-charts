...
Current chart version is `4.4.0-snapshot.1`
...
| hbase.stackgraph.image.tag | string | `"4.1.0"` | The StackGraph server version, must be compatible with the StackState version |
