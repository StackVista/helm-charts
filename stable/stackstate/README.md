...
Current chart version is `4.5.0-snapshot.24`
...
| https://helm.stackstate.io | anomaly-detection | 4.5.0-snapshot.104 |
| https://helm.stackstate.io | cluster-agent | 0.4.22 |
| https://helm.stackstate.io | common | 0.4.17 |
| https://helm.stackstate.io | elasticsearch | 7.6.2-stackstate.18 |
...
| stackstate.components.kafkaTopicCreate.image.tag | string | `"3.0.0-focal-20210827-r6"` | Container image tag for kafka-topic-create containers. |
