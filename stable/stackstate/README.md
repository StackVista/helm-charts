...
Current chart version is `5.1.9`
...
| stackstate.components.all.image.tag | string | `"5.1.9"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
