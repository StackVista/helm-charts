...
| https://helm.stackstate.io | anomaly-detection | 4.3.4 |
...
| stackstate.components.all.image.tag | string | `"4.3.4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
