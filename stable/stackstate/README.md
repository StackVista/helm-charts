...
Current chart version is `5.2.0-pre.4.rc.2`
...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-pre.4.rc.2 |
...
| hbase.stackgraph.image.tag | string | `"4.11.4"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"5.2.0-pre.4.rc.2"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.experimental.disableMultimetrics | bool | `false` | (boolean) Disable writing and storage of the old multimetrics format, this will break streams and checks, monitors and metric bindings use the new metrics |
| stackstate.experimental.metrics | bool | `false` | (boolean) Enable the new experimental metrics apis and store |
