...
| https://helm.stackstate.io | hbase | 0.1.101 |
...
| stackstate.components.kafkaTopicCreate.image.tag | string | `"2.3.1-focal-20210827-r41"` | Container image tag for kafka-topic-create containers. |
