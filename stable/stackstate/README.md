...
Current chart version is `5.2.0-snapshot.12`
...
| hbase.stackgraph.image.tag | string | `"4.11.5"` | The StackGraph server version, must be compatible with the StackState version |
