...
Current chart version is `4.5.0-pre.1.rc.10`
...
| https://helm.stackstate.io | anomaly-detection | 4.5.0-pre.1.rc.10 |
...
| hbase.stackgraph.image.tag | string | `"4.1.8"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"4.5.0-pre.1.rc.10"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.components.containerTools.image.tag | string | `"1.0.2"` | Container image tag for container-tools containers. |
...
| stackstate.components.nginxPrometheusExporter.image.tag | string | `"0.7.0"` | Container image tag for nginx-prometheus-exporter containers. |
...
| stackstate.components.router.image.tag | string | `"v1.15.5"` | Tag used for the `router` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.wait.image.tag | string | `"1.0.2"` | Container image tag for wait containers. |
