...
Current chart version is `4.5.0-snapshot.20`
...
| hbase.stackgraph.image.tag | string | `"4.2.7"` | The StackGraph server version, must be compatible with the StackState version |
