...
Current chart version is `4.2.0-snapshot.37`
...
| hbase.stackgraph.image.tag | string | `"3.6.12"` | The StackGraph server version, must be compatible with the StackState version |
