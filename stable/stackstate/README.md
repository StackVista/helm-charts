...
Current chart version is `4.5.0-rc.4`
...
| https://helm.stackstate.io | anomaly-detection | 4.5.0-rc.4 |
...
| hbase.stackgraph.image.tag | string | `"4.2.11"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"4.5.0-rc.4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
