...
Current chart version is `4.3.0-snapshot.18`
...
| stackstate.components.sync.resources | object | `{"limits":{"cpu":"2500m","memory":"3500Mi"},"requests":{"cpu":"2000m","memory":"3500Mi"}}` | Resource allocation for `sync` pods. |
