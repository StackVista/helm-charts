...
Current chart version is `4.4.4-rc.6`
...
| https://helm.stackstate.io | anomaly-detection | 4.4.4-rc.6 |
...
| hbase.stackgraph.image.tag | string | `"4.1.11"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"4.4.4-rc.6"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
