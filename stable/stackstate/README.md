...
Current chart version is `4.4.0-pre.0.rc.1`
...
| https://helm.stackstate.io | anomaly-detection | 4.4.0-pre.0.rc.1 |
...
| hbase.stackgraph.image.tag | string | `"4.1.2"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"4.4.0-pre.0.rc.1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
