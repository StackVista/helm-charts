...
Current chart version is `4.4.0-pre.3.rc.4`
...
| https://helm.stackstate.io | anomaly-detection | 4.4.0-pre.3.rc.4 |
...
| stackstate.components.all.image.tag | string | `"4.4.0-pre.3.rc.4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
