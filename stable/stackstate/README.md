...
Current chart version is `4.2.0-snapshot.3`
...
| https://helm.stackstate.io | hbase | 0.1.42 |
...
| hbase.stackgraph.image.tag | string | `"3.0.0"` | The StackGraph server version, must be compatible with the StackState version |
