...
Current chart version is `4.2.0-snapshot.44`
...
| https://helm.stackstate.io | anomaly-detection | 4.1.26 |
...
| hbase.stackgraph.image.tag | string | `"3.6.15"` | The StackGraph server version, must be compatible with the StackState version |
