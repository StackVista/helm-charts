...
Current chart version is `4.3.0-snapshot.30`
...
| https://helm.stackstate.io | anomaly-detection | 4.3.0-snapshot.112 |
...
| hbase.stackgraph.image.tag | string | `"3.7.5"` | The StackGraph server version, must be compatible with the StackState version |
