...
Current chart version is `4.6.0-snapshot.21`
...
| https://helm.stackstate.io | anomaly-detection | 4.5.0-snapshot.212 |
...
| hbase.stackgraph.image.tag | string | `"4.6.2"` | The StackGraph server version, must be compatible with the StackState version |
