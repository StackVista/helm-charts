...
Current chart version is `0.4.46`
...
| https://helm.stackstate.io | anomaly-detection | 4.1.1 |
...
| elasticsearch.resources.requests.cpu | string | `"2000m"` |  |
| elasticsearch.resources.requests.memory | string | `"3Gi"` |  |
