...
| stackstate.components.healthSync.resources | object | `{"limits":{"cpu":"1500m","memory":"1500Mi"},"requests":{"cpu":"1500m","memory":"1500Mi"}}` | Resource allocation for `healthSync` pods. |
