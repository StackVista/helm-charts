...
Current chart version is `4.6.0-pre.0.rc.3`
...
| https://helm.stackstate.io | anomaly-detection | 4.6.0-pre.0.rc.3 |
...
| hbase.stackgraph.image.tag | string | `"4.6.0-pre.0.rc.3"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"4.6.0-pre.0.rc.3"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
