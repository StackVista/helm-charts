...
Current chart version is `4.6.0-pre.4.rc.2`
...
| https://helm.stackstate.io | anomaly-detection | 4.6.0-pre.4.rc.2 |
...
| kafka.extraEnvVars | list | `[{"name":"KAFKA_CFG_RESERVED_BROKER_MAX_ID","value":"2000"},{"name":"KAFKA_CFG_TRANSACTIONAL_ID_EXPIRATION_MS","value":"31556952000"}]` | Extra environment variables to add to kafka pods. |
...
| stackstate.components.all.image.tag | string | `"4.6.0-pre.4.rc.2"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
