...
Current chart version is `5.2.0-pre.2.rc.2`
...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-pre.2.rc.2 |
...
| hbase.stackgraph.image.tag | string | `"4.11.1"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"5.2.0-pre.2.rc.2"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
