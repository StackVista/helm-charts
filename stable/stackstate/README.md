...
Current chart version is `5.1.0-snapshot.16`
...
| hbase.stackgraph.image.tag | string | `"4.7.0"` | The StackGraph server version, must be compatible with the StackState version |
