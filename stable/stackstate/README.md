...
Current chart version is `4.2.0-snapshot.36`
...
| hbase.stackgraph.image.tag | string | `"3.6.10"` | The StackGraph server version, must be compatible with the StackState version |
