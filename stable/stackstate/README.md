...
Current chart version is `4.2.5`
...
| stackstate.components.all.image.tag | string | `"4.2.5"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
