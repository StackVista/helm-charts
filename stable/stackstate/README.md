...
Current chart version is `4.3.0-snapshot.31`
...
| hbase.stackgraph.image.tag | string | `"4.0.0"` | The StackGraph server version, must be compatible with the StackState version |
