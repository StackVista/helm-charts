...
Current chart version is `4.5.0-snapshot.7`
...
| https://helm.stackstate.io | anomaly-detection | 4.5.0-snapshot.12 |
...
| hbase.stackgraph.image.tag | string | `"4.2.0"` | The StackGraph server version, must be compatible with the StackState version |
