...
Current chart version is `5.1.5-rc.1`
...
| https://helm.stackstate.io | anomaly-detection | 5.1.5-rc.1 |
...
| global.commonLabels | object | `{"app.kubernetes.io/part-of":"stackstate"}` | Add additional labels to all resources created for kafka and zookeeper |
...
| stackstate.components.all.image.tag | string | `"5.1.5-rc.1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
