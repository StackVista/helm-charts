...
Current chart version is `5.0.5-rc.1`
...
| https://helm.stackstate.io | anomaly-detection | 5.0.5-rc.1 |
...
| stackstate.components.all.image.tag | string | `"5.0.5-rc.1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
