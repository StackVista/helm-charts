...
Current chart version is `4.5.0-snapshot.15`
...
| https://helm.stackstate.io | anomaly-detection | 4.5.0-snapshot.25 |
| https://helm.stackstate.io | cluster-agent | 0.4.22 |
| https://helm.stackstate.io | common | 0.4.16 |
| https://helm.stackstate.io | elasticsearch | 7.6.2-stackstate.16 |
...
| hbase.stackgraph.image.tag | string | `"4.2.5"` | The StackGraph server version, must be compatible with the StackState version |
