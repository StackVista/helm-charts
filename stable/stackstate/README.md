...
Current chart version is `4.5.0-snapshot.8`
...
| hbase.stackgraph.image.tag | string | `"4.2.1"` | The StackGraph server version, must be compatible with the StackState version |
