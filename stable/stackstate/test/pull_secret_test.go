...
func TestPullSecret(t *testing.T) {
	...
	deploymentsToCheck := []string{"api", "checks", "correlate", "initializer", "receiver", "slicing", "state", "problem-producer", "sync", "view-health", "mm2es", "e2es", "trace2es", "kafka2prom-0", "kafka2prom-1"}
...
func TestPullSecretGlobalNamed(t *testing.T) {
	...
	resources := helmtestutil.NewKubernetesResources(t, output)
	deploymentsToCheck := []string{"api", "checks", "correlate", "initializer", "receiver", "slicing", "state", "problem-producer", "sync", "view-health", "mm2es", "e2es", "trace2es", "kafka2prom-0"}
