...
normalTopics=("sts_internal_topology" "sts_connection_beat_events" "sts_topology_events" "sts_generic_events" "sts_internal_events" "sts_multi_metrics" "sts_state_events" "sts_topo_process_agents" "sts_topo_trace_agents")
