...
def main():
  backup_datetime_re = re.compile(os.getenv('BACKUP_SCHEDULED_BACKUP_NAME_PARSE_REGEXP'))
  backup_datetime_format = os.getenv('BACKUP_SCHEDULED_BACKUP_DATETIME_PARSE_FORMAT')
  backup_retention_timedelta = eval('timedelta(' + os.getenv('BACKUP_SCHEDULED_BACKUP_RETENTION_TIME_DELTA') + ')')
