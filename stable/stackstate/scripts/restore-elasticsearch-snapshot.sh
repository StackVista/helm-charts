...
echo "=== Restoring ElasticSearch snapshot \"${SNAPSHOT_NAME}\" from snapshot repository \"${BACKUP_ELASTICSEARCH_SNAPSHOT_REPOSITORY_NAME}\" in bucket \"${BACKUP_ELASTICSEARCH_BUCKET_NAME}\"..."
