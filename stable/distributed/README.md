...
| stackstate.components.receiver.resources | object | `{"limits":{"memory":"1500Mi"},"requests":{"memory":"1500Mi"}}` | Resource allocation for `receiver` pods. |
