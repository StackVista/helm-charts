...
uploadFileToS3 "${TMP_DIR}/${STACKPACKS_BACKUP_FILE}" "s3://${BACKUP_STACKGRAPH_BUCKET_NAME}/${BACKUP_STACKGRAPH_STACKPACKS_S3_PREFIX}${STACKPACKS_BACKUP_FILE}" "http://${S3_ENDPOINT}"
