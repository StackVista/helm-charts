...
sts-toolbox aws s3 cp --endpoint "http://${MINIO_ENDPOINT}" --region minio "${TMP_DIR}/${BACKUP_FILE}" "s3://${BACKUP_CONFIGURATION_BUCKET_NAME}/${BACKUP_CONFIGURATION_S3_PREFIX}${BACKUP_FILE}"
