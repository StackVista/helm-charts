...
Current chart version is `2.9.1-pre.131`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260429103232-master-561c1e3"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
