...
Current chart version is `2.8.2-pre.18`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260320140433-master-81a0496"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
