...
Current chart version is `2.10.3-pre.38`
...
| anomaly-detection.image.tag | string | `"5.2.0-snapshot.212"` | the chart image tag, e.g. 4.1.3-latest |
...
| clickhouse.backup.image.tag | string | `"2.7.2-so4"` | Container image tag for 'clickhouse' backup containers. |
...
| clickhouse.image.tag | string | `"26.5.1-so4"` | Container image tag for 'clickhouse' containers. |
...
| elasticsearch.imageTag | string | `"8.19.16-so6"` | Elasticsearch image tag. Updated by updatecli. |
| elasticsearch.prometheus-elasticsearch-exporter.image.tag | string | `"1.10.0-so9"` | Elasticsearch Prometheus exporter image tag. Updated by updatecli. |
...
| global.wait.image.tag | string | `"1.0.12-so6"` | Container image tag for wait containers. |
...
| hbase.hdfs.version | string | `"3.5.0-so7"` | Full HDFS image tag. Updated by updatecli. |
| hbase.stackgraph.version | string | `"8.1.9"` |  |
...
| kafka.image.tag | string | `"3.9.2-so12"` | Kafka image tag. **Since StackState relies on this specific version, it's advised NOT to change this.** When changing this version, be sure to change the pod annotation stackstate.com/kafkaup-operator.kafka_version aswell, in order for the kafkaup operator to upgrade the inter broker protocol version |
...
| kafka.metrics.jmx.image.tag | string | `"0.20.0-so7"` | Kafka JMX exporter image tag |
...
| kafkaup-operator.image.tag | string | `"0.0.11"` |  |
...
| kubernetes-rbac-agent.containers.rbacAgent.image.tag | string | `"228cfb48-1011-release"` |  |
...
| s3proxy.image.tag | string | `"3.2.0-so4"` | Image tag for S3Proxy |
...
| stackstate.components.aiAssistant.image.tag | string | `"20260707045305-0cb32305"` | Tag used for the `ai-assistant` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260710075421-master-ce30f5e"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.clickhouseCleanup.image.tag | string | `"26.5.1-so4"` | Container image tag for 'clickhouseCleanup' containers. |
...
| stackstate.components.containerTools.image.tag | string | `"1.8.6-so13"` | Container image tag for container-tools containers. |
...
| stackstate.components.kafkaTopicCreate.image.tag | string | `"3.9.2-so12"` | Container image tag for kafka-topic-create containers. |
...
| stackstate.components.mcp.image.tag | string | `"20260707043948-91337f25"` | Tag used for the `mcp` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.nginxPrometheusExporter.image.tag | string | `"1.5.1-so9"` | Container image tag for nginx-prometheus-exporter containers. |
...
| stackstate.components.router.image.tag | string | `"1.38.3-so1"` | Tag used for the `router` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.router.mode.image.tag | string | `"1.8.6-so13"` | Container image tag for router mode containers. |
...
| stackstate.components.vmagent.image.tag | string | `"1.144.0-so8"` |  |
...
| stackstate.components.workloadObserver.image.tag | string | `"cce5a402-1010-release"` | Tag used for the `workloadObserver` component Docker image.. |
...
| stackstate.stackpacks.images[0].deploymentModeOverride | string | `""` |  |
| stackstate.stackpacks.images[0].name | string | `"v1"` |  |
| stackstate.stackpacks.images[0].pullPolicy | string | `""` |  |
| stackstate.stackpacks.images[0].registry | string | `"quay.io"` |  |
| stackstate.stackpacks.images[0].repository | string | `"stackstate/stackpacks"` |  |
| stackstate.stackpacks.images[0].version | string | `"20260708133728-master-cad7c72"` |  |
| stackstate.stackpacks.images[1].deploymentModeOverride | string | `""` |  |
| stackstate.stackpacks.images[1].name | string | `"contrib"` |  |
| stackstate.stackpacks.images[1].pullPolicy | string | `""` |  |
| stackstate.stackpacks.images[1].registry | string | `"ghcr.io"` |  |
| stackstate.stackpacks.images[1].repository | string | `"stackvista/contrib-stackpacks"` |  |
| stackstate.stackpacks.images[1].version | string | `"20260703131618-STAC-24722-community-stackpacks-in-contrib-5a6af30"` |  |
...
| victoria-metrics-0.backup.setupCron.image.tag | string | `"1.8.6-so13"` | Container-tools image for cron setup. Updated by updatecli. |
| victoria-metrics-0.backup.vmbackup.image.tag | string | `"1.144.0-so9"` | VM backup image tag. Updated by updatecli. |
...
| victoria-metrics-0.server.image.tag | string | `"1.144.0-so8"` | Victoria Metrics server image tag. Updated by updatecli. |
...
| victoria-metrics-1.backup.setupCron.image.tag | string | `"1.8.6-so13"` | Container-tools image for cron setup. Updated by updatecli. |
| victoria-metrics-1.backup.vmbackup.image.tag | string | `"1.144.0-so9"` | VM backup image tag. Updated by updatecli. |
...
| victoria-metrics-1.server.image.tag | string | `"1.144.0-so8"` | Victoria Metrics server image tag. Updated by updatecli. |
...
| victoria-metrics.restore.image.tag | string | `"1.144.0-so8"` | Container image tag for 'vmrestore' containers. |
...
| zookeeper.image.tag | string | `"3.9.5-so14"` | ZooKeeper image tag |
