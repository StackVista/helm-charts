...
Current chart version is `2.1.2-pre.40`
...
| hbase.stackgraph.version | string | `"7.8.1"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241129081542-master-659201d"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
