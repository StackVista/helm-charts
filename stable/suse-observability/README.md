...
Current chart version is `2.3.1-pre.30`
...
| https://helm.stackstate.io | kubernetes-rbac-agent | 0.0.5 |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250225084902-master-566fda6"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
