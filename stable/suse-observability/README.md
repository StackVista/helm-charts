...
Current chart version is `2.6.2-pre.20`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251021075743-master-9b1bd2f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
