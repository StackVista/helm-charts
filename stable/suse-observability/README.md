...
Current chart version is `2.3.1-pre.50`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250307091407-master-e6bbb65"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
