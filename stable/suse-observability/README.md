...
Current chart version is `2.0.2-pre.30`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241002074936-master-9ba2f3a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
