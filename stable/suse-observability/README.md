...
Current chart version is `2.6.2-pre.3`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251014094214-master-43f483b"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
