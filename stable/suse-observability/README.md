...
Current chart version is `2.0.1-pre.10`
...
| stackstate.stackpacks.image.version | string | `"20240912080919-master-58c2306"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
