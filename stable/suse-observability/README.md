...
Current chart version is `2.10.1-pre.23`
...
| hbase.stackgraph.version | string | `"8.0.2"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260513194118-master-a14965c"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
