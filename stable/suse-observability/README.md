...
Current chart version is `2.3.6-pre.35`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250709123456-master-7e8aa8f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
