...
Current chart version is `2.7.1-pre.35`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260128112832-master-e3c97f2"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
