...
Current chart version is `2.7.1-pre.34`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260128104256-master-3cc469f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
