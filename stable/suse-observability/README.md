...
Current chart version is `2.10.4-pre.15`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260807152955-master-76e72a2"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.images[1].tag | string | `"20260810143335-main-2ba911a"` | Tag used for the `stackpacks` Docker image |
