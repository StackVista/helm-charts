...
Current chart version is `2.10.3-pre.63`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260721072106-master-a9d55b0"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
