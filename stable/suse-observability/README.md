...
Current chart version is `2.3.8-pre.23`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250801113259-master-7080fbf"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
