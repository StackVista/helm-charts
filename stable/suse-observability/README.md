...
Current chart version is `2.0.3-pre.37`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241021162810-master-15c06e1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
