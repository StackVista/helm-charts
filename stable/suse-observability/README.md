...
Current chart version is `2.3.6-pre.46`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250711074426-master-8d149cb"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
