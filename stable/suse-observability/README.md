...
| file://../victoria-metrics-single/ | victoria-metrics-0(victoria-metrics-single) | 0.8.53-stackstate.18 |
| file://../victoria-metrics-single/ | victoria-metrics-1(victoria-metrics-single) | 0.8.53-stackstate.18 |
...
| stackstate.components.containerTools.image.tag | string | `"1.5.4"` | Container image tag for container-tools containers. |
...
| stackstate.components.router.mode.image.tag | string | `"1.5.4"` | Container image tag for router mode containers. |
