...
Current chart version is `2.3.2-pre.46`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250409130824-master-1d8a2b1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
