...
Current chart version is `2.11.2-pre.21`
...
| opentelemetry-collector.image.tag | string | `"v0.0.57"` | Container image tag for 'opentelemetry-collector' containers. |
...
| stackstate.stackpacks.images[1].tag | string | `"20260919092541-main-2e3ac59"` | Tag used for the `stackpacks` Docker image |
...
| stackstate.stackpacks.images[2].tag | string | `"20260919092556-main-c22afee"` | Tag used for the `stackpacks` Docker image |
