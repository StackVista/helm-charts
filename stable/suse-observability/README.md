...
Current chart version is `2.2.2-pre.22`
...
| stackstate.stackpacks.image.version | string | `"20250106102747-master-1431113"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
