...
Current chart version is `2.3.8-pre.4`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250728134554-master-6c9a704"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
