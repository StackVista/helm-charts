...
Current chart version is `2.10.3-pre.44`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260710120322-master-4e7f925"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.images[1].tag | string | `"20260710115211-main-2debb2b"` | Tag used for the `stackpacks` Docker image |
