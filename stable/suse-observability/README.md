...
Current chart version is `2.3.1-pre.46`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250305112813-master-b8c3a3e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
