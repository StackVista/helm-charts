...
Current chart version is `2.5.1-pre.18`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250917102727-master-14cae0d"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250911152945-master-41a6c5e"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
