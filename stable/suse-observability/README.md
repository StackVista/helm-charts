...
Current chart version is `2.11.2-pre.24`
...
| kafkaup-operator.image.tag | string | `"0.0.15"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260919122235-master-6996332"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
