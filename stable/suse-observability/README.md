...
Current chart version is `2.10.1-pre.19`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260513071430-master-c33129f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20260512135019-master-9dc1490"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
