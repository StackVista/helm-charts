...
Current chart version is `2.7.1-pre.96`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260218091845-master-e9eac7f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
