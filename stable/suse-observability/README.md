...
Current chart version is `2.10.4-pre.50`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260831185122-master-0c2240b"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
