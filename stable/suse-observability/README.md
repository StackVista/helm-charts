...
Current chart version is `2.10.2-pre.102`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260624092434-master-f9b5d0c"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
