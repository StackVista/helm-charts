...
Current chart version is `2.10.1-pre.30`
...
| hbase.stackgraph.version | string | `"8.0.5"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260519145340-master-55c39c8"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
