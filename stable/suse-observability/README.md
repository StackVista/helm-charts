...
Current chart version is `2.10.4-pre.19`
...
| hbase.stackgraph.version | string | `"8.3.4"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260818072719-master-3832ac3"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
