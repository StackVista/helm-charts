...
Current chart version is `2.0.3-pre.42`
...
| stackstate.stackpacks.image.version | string | `"20241021113514-master-1d48fe4"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
