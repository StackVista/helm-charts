...
Current chart version is `2.10.1-pre.22`
...
| hbase.stackgraph.version | string | `"8.0.1"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260513083427-master-c9594d4"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
