...
Current chart version is `2.6.4-pre.40`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251215082041-master-0a53a11"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
