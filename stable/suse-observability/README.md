...
Current chart version is `2.7.1-pre.24`
...
| stackstate.stackpacks.image.version | string | `"20260127112136-master-2d299a1"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
