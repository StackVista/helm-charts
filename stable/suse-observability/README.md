...
Current chart version is `2.6.2-pre.34`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251029091803-master-17280e0"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
