...
Current chart version is `2.11.2-pre.7`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260915182214-master-7213faf"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
