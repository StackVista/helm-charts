...
Current chart version is `2.3.8-pre.7`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250729074531-master-2ec965b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
