...
Current chart version is `2.6.4-pre.19`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251201075720-master-2d2f576"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20251204080354-master-6650b2b"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
