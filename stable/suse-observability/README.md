...
Current chart version is `2.3.6-pre.34`
...
| stackstate.stackpacks.image.version | string | `"20250709143739-master-653bf28"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
