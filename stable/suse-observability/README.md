...
Current chart version is `2.5.0-pre.9`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250909144324-master-d2132bb"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
