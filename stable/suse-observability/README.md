...
Current chart version is `2.10.3-pre.14`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260701123805-master-bc3ce4e"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
