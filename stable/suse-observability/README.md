...
Current chart version is `2.0.3-pre.10`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241007101011-master-0c6d5b7"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20241004144238-master-9502a2c"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
