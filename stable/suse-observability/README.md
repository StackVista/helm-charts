...
Current chart version is `2.7.1-pre.50`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260202101433-master-0e77a00"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
