...
Current chart version is `2.3.3-pre.10`
...
| stackstate.stackpacks.image.version | string | `"20250506092252-master-7dded27"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
