...
Current chart version is `2.6.4-pre.43`
...
| hbase.stackgraph.version | string | `"7.13.10"` | The StackGraph server version, must be compatible with the StackState version |
