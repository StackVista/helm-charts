...
Current chart version is `2.3.7-pre.14`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250728083541-master-a0659db"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
