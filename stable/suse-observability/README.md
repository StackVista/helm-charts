...
| hbase.stackgraph.version | string | `"8.3.10"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260828164125-master-66477d6"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
