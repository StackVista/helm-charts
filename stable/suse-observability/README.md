...
Current chart version is `2.4.1-pre.14`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250829092953-master-b4737c5"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250820143521-master-38124ea"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
