...
Current chart version is `2.3.2-pre.7`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250319185537-master-045c805"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
