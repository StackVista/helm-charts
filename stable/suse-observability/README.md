...
Current chart version is `2.8.1-pre.13`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260306144508-master-9f992fe"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
