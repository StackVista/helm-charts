...
Current chart version is `2.7.1-pre.13`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260120082832-master-71580a5"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
