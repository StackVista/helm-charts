...
Current chart version is `2.7.1-pre.101`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260224114155-master-0eca6af"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
