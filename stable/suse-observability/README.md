...
Current chart version is `2.3.4-pre.24`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250516161701-master-dc0700b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250515110350-master-f3a4f4e"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
