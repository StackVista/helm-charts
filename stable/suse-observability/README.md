...
Current chart version is `2.3.8-pre.34`
...
| hbase.stackgraph.version | string | `"7.11.3"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250806085157-master-368fdb0"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
