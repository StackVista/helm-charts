...
Current chart version is `2.11.2-pre.18`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260918091653-master-d21c8ff"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
