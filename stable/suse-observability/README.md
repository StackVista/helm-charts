...
Current chart version is `2.10.2-pre.101`
...
| stackstate.stackpacks.image.version | string | `"20260618113525-master-8da689c"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
