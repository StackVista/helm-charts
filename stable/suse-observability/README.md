...
Current chart version is `2.8.1-pre.37`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260313081723-master-bc17cc1"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
