...
Current chart version is `2.6.4-pre.24`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251209110507-master-2f67bff"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
