...
Current chart version is `2.3.6-pre.56`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250716113402-master-6f4dbaa"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
