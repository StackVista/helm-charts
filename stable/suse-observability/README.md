...
Current chart version is `2.0.2-pre.29`
...
| hbase.stackgraph.version | string | `"7.7.4"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241001173137-master-1a7e1c4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
