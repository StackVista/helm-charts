...
Current chart version is `2.10.2-pre.85`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260618125959-master-a4d1e18"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
