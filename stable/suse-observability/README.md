...
| stackstate.components.containerTools.image.tag | string | `"stac-21887-drop-useradd"` | Container image tag for container-tools containers. |
...
| stackstate.components.router.mode.image.tag | string | `"stac-21887-drop-useradd"` | Container image tag for router mode containers. |
