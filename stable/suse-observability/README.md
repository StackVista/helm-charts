...
Current chart version is `2.9.1-pre.73`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260414131521-master-7d84797"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20260414110340-master-674433f"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
