...
Current chart version is `2.3.2-pre.35`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250401150321-master-8a3c619"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
