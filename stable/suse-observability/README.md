...
Current chart version is `2.3.2-pre.60`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250417105952-master-5dc4d88"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250416111629-master-8947961"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
