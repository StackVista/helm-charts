...
Current chart version is `2.10.3-pre.104`
...
| hbase.stackgraph.version | string | `"8.3.3"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260804085444-master-916f2fe"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.images[1].tag | string | `"20260804092344-main-4a2553c"` | Tag used for the `stackpacks` Docker image |
