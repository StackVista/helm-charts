...
Current chart version is `2.8.2-pre.16`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260320092351-master-f8f22e7"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
