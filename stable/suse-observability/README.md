...
Current chart version is `2.10.4-pre.69`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260906191430-master-fee916c"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
