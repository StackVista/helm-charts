...
Current chart version is `2.0.3-pre.2`
...
| stackstate.stackpacks.image.version | string | `"20241004132741-master-df78c20"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
