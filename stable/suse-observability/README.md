...
Current chart version is `2.0.3-pre.21`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241011101034-master-a611b5f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
