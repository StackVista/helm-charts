...
Current chart version is `2.9.1-pre.130`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260429092737-master-097dc33"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
