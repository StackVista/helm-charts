...
Current chart version is `2.8.2-pre.10`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260318083721-master-c594906"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20260313204426-master-f3cd7eb"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
