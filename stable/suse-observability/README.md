...
Current chart version is `2.3.1-pre.25`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250212104257-master-ceffee9"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
