...
Current chart version is `2.9.1-pre.144`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260430104801-master-e0e6c9d"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
