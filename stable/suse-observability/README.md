...
Current chart version is `2.6.1-pre.34`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251008145034-master-4e6f609"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
