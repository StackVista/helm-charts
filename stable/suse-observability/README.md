...
Current chart version is `2.5.2-pre.6`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250929085550-master-178262e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
