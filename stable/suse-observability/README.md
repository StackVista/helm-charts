...
Current chart version is `2.3.1-pre.57`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250311134853-master-a079faf"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
