...
Current chart version is `2.3.4-pre.42`
...
| stackstate.stackpacks.image.version | string | `"20250528075157-master-3d9fc7d"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
