...
Current chart version is `2.10.4-pre.59`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260901092150-master-2e929ee"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
