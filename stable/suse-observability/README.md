...
Current chart version is `2.3.2-pre.44`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250409084248-master-90c3ea6"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250403110905-master-37428e9"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
