...
Current chart version is `2.10.3-pre.99`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260729180335-master-08c2b3b"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
