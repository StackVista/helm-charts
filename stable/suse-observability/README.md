...
Current chart version is `2.10.4-pre.8`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260806100202-master-3c36d85"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
