...
Current chart version is `2.0.2-pre.13`
...
| stackstate.stackpacks.image.version | string | `"20240925120421-master-2f4d917"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
