...
Current chart version is `2.10.3-pre.40`
...
| stackstate.stackpacks.images[0].version | string | `"20260710074540-master-7c43d83"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
...
| stackstate.stackpacks.images[1].tag | string | `"20260710111433-main-9144634"` | Tag used for the `stackpacks` Docker image |
