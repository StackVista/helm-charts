...
Current chart version is `2.3.2-pre.55`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250414122735-master-5c1fada"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
