...
Current chart version is `2.3.2-pre.24`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250327101642-master-d141d8f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
