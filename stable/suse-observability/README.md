...
Current chart version is `2.10.3-pre.24`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260703094412-master-3768f10"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
