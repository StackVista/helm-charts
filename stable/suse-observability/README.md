...
Current chart version is `2.7.1-pre.17`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260122134137-master-06b2d5c"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
