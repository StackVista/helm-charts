...
Current chart version is `2.2.2-pre.61`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250122095936-master-a271225"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250122092346-master-8e44427"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
