...
Current chart version is `2.3.2-pre.18`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250324162047-master-64ef29b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
