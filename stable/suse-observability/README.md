...
Current chart version is `2.1.2-pre.50`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241205124103-master-ce3b24e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20241206133839-master-0a24465"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
