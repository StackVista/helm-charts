...
Current chart version is `2.10.1-pre.32`
...
| hbase.stackgraph.version | string | `"8.0.6"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260520124221-master-f891ce7"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
