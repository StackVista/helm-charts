...
Current chart version is `2.3.8-pre.54`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250818075111-master-1117974"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
