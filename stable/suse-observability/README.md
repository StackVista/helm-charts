...
Current chart version is `2.7.1-pre.79`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260210161911-master-65f01f1"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
