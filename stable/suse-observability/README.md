...
Current chart version is `2.6.4-pre.78`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260106125620-master-adcb7ee"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
