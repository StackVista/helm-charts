...
Current chart version is `2.4.1-pre.18`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250903070115-master-19ca2d4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
