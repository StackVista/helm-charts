...
Current chart version is `2.10.1-pre.41`
...
| stackstate.stackpacks.image.version | string | `"20260522170547-master-31ffc16"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
