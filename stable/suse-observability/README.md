...
Current chart version is `2.3.5-pre.14`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250617133841-master-fb294f8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250604132238-master-845061c"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
