...
Current chart version is `2.0.2-pre.37`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241003113341-master-9fb862a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
