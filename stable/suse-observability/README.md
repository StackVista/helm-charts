...
Current chart version is `2.10.3-pre.95`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260728165540-master-89fb2aa"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.images[1].tag | string | `"20260729104846-main-56ce644"` | Tag used for the `stackpacks` Docker image |
