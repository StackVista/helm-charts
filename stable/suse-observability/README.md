...
Current chart version is `2.0.2-pre.14`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20240926092031-master-c0b63d1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20240927072207-master-05ffe1b"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
