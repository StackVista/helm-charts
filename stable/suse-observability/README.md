...
Current chart version is `2.8.2-pre.26`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260323154506-master-0002b3f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
