...
Current chart version is `2.10.4-pre.80`
...
| anomaly-detection.image.tag | string | `"5.2.0-snapshot.225"` | the chart image tag, e.g. 4.1.3-latest |
...
| stackstate.components.workloadObserver.image.tag | string | `"64188fd0-1033-release"` | Tag used for the `workloadObserver` component Docker image.. |
