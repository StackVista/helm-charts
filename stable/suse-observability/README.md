...
Current chart version is `2.3.6-pre.38`
...
| hbase.stackgraph.version | string | `"7.10.2"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250710110747-master-45caf2c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
