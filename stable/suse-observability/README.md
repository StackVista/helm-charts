...
Current chart version is `2.7.1-pre.65`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260205134900-master-1c73821"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20260205133800-master-e93e8a5"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
