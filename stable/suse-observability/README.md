...
Current chart version is `2.3.4-pre.25`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250516174244-master-623a43f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
