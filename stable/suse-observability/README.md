...
Current chart version is `2.3.4-pre.11`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250514144132-master-40c8c17"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
