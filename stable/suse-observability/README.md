...
Current chart version is `2.3.4-pre.50`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250603133333-master-bf5a18c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
