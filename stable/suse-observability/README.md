...
Current chart version is `2.5.1-pre.10`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250911114548-master-a02be56"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
