...
Current chart version is `2.10.4-pre.70`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260907053927-master-63bad9b"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
