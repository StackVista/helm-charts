...
Current chart version is `2.0.2-pre.4`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20240920084213-master-69b0904"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
