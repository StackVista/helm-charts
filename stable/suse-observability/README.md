...
Current chart version is `2.1.2-pre.35`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241126132402-master-a866a80"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
