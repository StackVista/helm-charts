...
Current chart version is `2.10.1-pre.29`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260519132553-master-5e7affe"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
