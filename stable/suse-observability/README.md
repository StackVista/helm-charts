...
Current chart version is `2.9.1-pre.163`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260501103324-master-d58b8dd"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
