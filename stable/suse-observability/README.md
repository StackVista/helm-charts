...
Current chart version is `2.8.1-pre.41`
...
| stackstate.components.aiAssistant.image.tag | string | `"20260311082059-fa69371c"` | Tag used for the `ai-assistant` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260316080614-master-8da9082"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
