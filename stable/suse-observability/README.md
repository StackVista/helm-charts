...
Current chart version is `2.6.4-pre.82`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260107153847-master-3a9a2e1"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
