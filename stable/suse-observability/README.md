...
Current chart version is `2.3.4-pre.28`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250519113923-master-db2f945"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
