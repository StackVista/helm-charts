...
Current chart version is `2.7.1-pre.8`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260119092117-master-0c9587e"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
