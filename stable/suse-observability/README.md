...
Current chart version is `2.6.4-pre.35`
...
| hbase.stackgraph.version | string | `"7.13.9"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251211135558-master-af6cf4f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
