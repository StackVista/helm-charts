...
Current chart version is `2.9.1-pre.54`
...
| file://../clickhouse/ | clickhouse | 3.6.9-suse-observability.24 |
| file://../common/ | common | * |
| file://../elasticsearch/ | elasticsearch | 8.19.4-stackstate.19 |
| file://../hbase/ | hbase | 0.2.132 |
| file://../kafka/ | kafka | 19.1.3-suse-observability.23 |
...
| file://../zookeeper/ | zookeeper | 8.1.2-suse-observability.21 |
...
| elasticsearch.prometheus-elasticsearch-exporter.image.tag | string | `"v1.8.0-58570ea7-release-164"` | Elasticsearch Prometheus exporter image tag. Updated by updatecli. |
...
| kubernetes-rbac-agent.containers.rbacAgent.image.tag | string | `"f2adc8df-618-release"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260410094049-master-1ce95f9"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.workloadObserver.image.tag | string | `"ab88e7da-116-release"` | Tag used for the `workloadObserver` component Docker image.. |
