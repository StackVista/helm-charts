...
| stackstate.stackpacks.image.version | string | `"20250901141318-master-c1ef42c"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
