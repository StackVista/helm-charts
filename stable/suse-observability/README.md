...
Current chart version is `2.3.6-pre.42`
...
| hbase.stackgraph.version | string | `"7.10.3"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250711071038-master-10867a8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
