...
Current chart version is `2.3.1-pre.20`
...
| https://helm.stackstate.io | kubernetes-rbac-agent | 0.0.4 |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250210095550-master-4d2f259"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
