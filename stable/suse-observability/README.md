...
Current chart version is `2.7.1-pre.78`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260209161834-master-76eda9e"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
