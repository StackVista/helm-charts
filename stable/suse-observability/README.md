...
Current chart version is `2.10.4-pre.73`
...
| hbase.stackgraph.version | string | `"8.3.12"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260907080201-master-5e5b4ae"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
