...
Current chart version is `2.6.3-pre.36`
...
| hbase.stackgraph.version | string | `"7.13.0"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251117102421-master-a4ff362"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
