...
Current chart version is `2.3.6-pre.58`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250716134644-master-3f94e01"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
