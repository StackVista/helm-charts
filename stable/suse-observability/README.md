...
Current chart version is `2.3.2-pre.40`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250403124710-master-0440461"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
