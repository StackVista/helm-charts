...
Current chart version is `2.0.3-pre.43`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241023095846-master-4534d26"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20241023120811-master-3b44c5c"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
