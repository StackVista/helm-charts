...
Current chart version is `2.10.2-pre.2`
...
| anomaly-detection.image.tag | string | `"5.2.0-snapshot.204"` | the chart image tag, e.g. 4.1.3-latest |
...
| clickhouse.backup.image.tag | string | `"2.6.43-b3764ea5-main-106"` | Container image tag for 'clickhouse' backup containers. |
...
| clickhouse.image.tag | string | `"rebuilt_zero_cve_25.9.6-b3764ea5-main-20"` | Container image tag for 'clickhouse' containers. |
...
| elasticsearch.imageTag | string | `"rebuilt_zero_cve_8.19.15-b3764ea5-main-25"` | Elasticsearch image tag. Updated by updatecli. |
| elasticsearch.prometheus-elasticsearch-exporter.image.tag | string | `"1.10.0-18e7ac19-main-6"` | Elasticsearch Prometheus exporter image tag. Updated by updatecli. |
...
| global.wait.image.tag | string | `"1.0.12-18e7ac19-main-10"` | Container image tag for wait containers. |
...
| hbase.hdfs.image.tag | string | `"3.4.3-java21-9-16889a20-release-402"` | Full HDFS image tag. When set, overrides the tag derived from hbase.hdfs.version. Updated by updatecli. |
| hbase.hdfs.version | string | `"java21-9-16889a20-release-402"` | HDFS image build suffix used when hbase.hdfs.image.tag is unset. |
| hbase.stackgraph.version | string | `"8.0.7"` |  |
...
| kafka.image.tag | string | `"rebuilt_zero_cve_3.9.2-b3764ea5-main-37"` | Kafka image tag. **Since StackState relies on this specific version, it's advised NOT to change this.** When changing this version, be sure to change the pod annotation stackstate.com/kafkaup-operator.kafka_version aswell, in order for the kafkaup operator to upgrade the inter broker protocol version |
...
| kafka.metrics.jmx.image.tag | string | `"0.20.0-b3764ea5-main-14"` | Kafka JMX exporter image tag |
...
| kafkaup-operator.image.tag | string | `"0.0.9"` |  |
...
| kubernetes-rbac-agent.containers.rbacAgent.image.tag | string | `"e78c10a7-740-release"` |  |
...
| opentelemetry-collector.image.tag | string | `"v0.0.36"` | Container image tag for 'opentelemetry-collector' containers. |
...
| s3proxy.image.tag | string | `"3.1.0-b3764ea5-main-68"` | Image tag for S3Proxy |
...
| stackstate.components.aiAssistant.image.tag | string | `"20260527050458-45510412"` | Tag used for the `ai-assistant` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260528113519-master-749bc87"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.clickhouseCleanup.image.tag | string | `"rebuilt_zero_cve_25.9.6-b3764ea5-main-20"` | Container image tag for 'clickhouseCleanup' containers. |
...
| stackstate.components.containerTools.image.tag | string | `"1.8.6-b3764ea5-main-109"` | Container image tag for container-tools containers. |
...
| stackstate.components.kafkaTopicCreate.image.tag | string | `"rebuilt_zero_cve_3.9.2-b3764ea5-main-37"` | Container image tag for kafka-topic-create containers. |
...
| stackstate.components.mcp.image.tag | string | `"20260527045301-ce870052"` | Tag used for the `mcp` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.nginxPrometheusExporter.image.tag | string | `"1.5.1-18e7ac19-main-75"` | Container image tag for nginx-prometheus-exporter containers. |
...
| stackstate.components.router.image.tag | string | `"1.38.0-1.4-release"` | Tag used for the `router` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.router.mode.image.tag | string | `"1.8.6-b3764ea5-main-109"` | Container image tag for router mode containers. |
...
| stackstate.components.vmagent.image.tag | string | `"v1.143.0-b3764ea5-main-76"` |  |
...
| stackstate.components.workloadObserver.image.tag | string | `"5fe52727-204-release"` | Tag used for the `workloadObserver` component Docker image.. |
...
| stackstate.stackpacks.image.version | string | `"20260526120532-master-e18c0f1"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
...
| victoria-metrics-0.backup.setupCron.image.tag | string | `"1.8.6-b3764ea5-main-109"` | Container-tools image for cron setup. Updated by updatecli. |
| victoria-metrics-0.backup.vmbackup.image.tag | string | `"v1.143.0-b3764ea5-main-76"` | VM backup image tag. Updated by updatecli. |
...
| victoria-metrics-0.server.image.tag | string | `"v1.143.0-b3764ea5-main-76"` | Victoria Metrics server image tag. Updated by updatecli. |
...
| victoria-metrics-1.backup.setupCron.image.tag | string | `"1.8.6-b3764ea5-main-109"` | Container-tools image for cron setup. Updated by updatecli. |
| victoria-metrics-1.backup.vmbackup.image.tag | string | `"v1.143.0-b3764ea5-main-76"` | VM backup image tag. Updated by updatecli. |
...
| victoria-metrics-1.server.image.tag | string | `"v1.143.0-b3764ea5-main-76"` | Victoria Metrics server image tag. Updated by updatecli. |
...
| victoria-metrics.restore.image.tag | string | `"v1.143.0-b3764ea5-main-76"` | Container image tag for 'vmrestore' containers. |
...
| zookeeper.image.tag | string | `"rebuilt_zero_cve_3.9.5-b3764ea5-main-23"` | ZooKeeper image tag |
