...
Current chart version is `2.3.4-pre.22`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250516102030-master-a4da5d9"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
