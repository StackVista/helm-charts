...
Current chart version is `2.2.2-pre.58`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250121171435-master-d33e8f7"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
