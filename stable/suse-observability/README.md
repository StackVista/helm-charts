...
Current chart version is `2.3.6-pre.68`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250722101925-master-b8ab56c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
