...
Current chart version is `2.3.4-pre.12`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250515091135-master-95b31c1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
