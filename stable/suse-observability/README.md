...
Current chart version is `2.10.2-pre.90`
...
| elasticsearch.imageTag | string | `"8.19.15-so4"` | Elasticsearch image tag. Updated by updatecli. |
...
| hbase.hdfs.version | string | `"3.4.3-so6"` | Full HDFS image tag. Updated by updatecli. |
...
| s3proxy.image.tag | string | `"3.1.0-so4"` | Image tag for S3Proxy |
...
| stackstate.components.aiAssistant.image.tag | string | `"20260619052035-de5af9c4"` | Tag used for the `ai-assistant` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260619085906-master-5e56e78"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.mcp.image.tag | string | `"20260619050054-5721dae6"` | Tag used for the `mcp` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| zookeeper.image.tag | string | `"3.9.5-so6"` | ZooKeeper image tag |
