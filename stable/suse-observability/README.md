...
Current chart version is `2.3.5-pre.23`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250619150600-master-93edf58"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
