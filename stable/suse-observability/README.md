...
Current chart version is `2.2.2-pre.69`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250127175803-master-bea0e90"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
