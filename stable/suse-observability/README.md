...
Current chart version is `2.10.1-pre.53`
...
| hbase.hdfs.version | string | `"java21-9-16889a20-release-402"` | HDFS image build version (e.g. java21-8-27156f06-353). Derived from hadoop docker tag with semver prefix stripped. Updated by updatecli. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260528103402-master-6afc445"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
