...
Current chart version is `2.10.3-pre.76`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260723150727-master-ee18ed0"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
