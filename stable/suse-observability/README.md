...
Current chart version is `2.10.2-pre.76`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260616085820-master-47f20eb"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
