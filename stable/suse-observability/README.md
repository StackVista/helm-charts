...
Current chart version is `2.8.1-pre.22`
...
| stackstate.stackpacks.image.version | string | `"20260304110718-master-125cdb2"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
