...
Current chart version is `2.10.2-pre.80`
...
| stackstate.stackpacks.image.version | string | `"20260617075215-master-6341790"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
