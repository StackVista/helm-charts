...
Current chart version is `2.4.1-pre.8`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250827090300-master-23ca8be"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
