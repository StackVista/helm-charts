...
Current chart version is `2.6.3-pre.3`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251103125228-master-0a0cf16"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
