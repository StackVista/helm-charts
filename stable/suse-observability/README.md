...
Current chart version is `2.6.3-pre.11`
...
| stackstate.stackpacks.image.version | string | `"20251105112354-master-8d3fa0f"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
