...
Current chart version is `2.3.1-pre.58`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250312132051-master-31e9e8f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
