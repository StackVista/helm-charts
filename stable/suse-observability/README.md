...
Current chart version is `2.3.1-pre.42`
...
| https://helm.stackstate.io | kubernetes-rbac-agent | 0.0.8 |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250226104339-master-82ecc72"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
