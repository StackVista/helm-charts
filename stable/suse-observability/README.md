...
Current chart version is `2.3.1-pre.56`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250310172209-master-3fec652"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
