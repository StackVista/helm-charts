...
Current chart version is `2.3.6-pre.70`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250722112540-master-34e65ce"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
