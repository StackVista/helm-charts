...
Current chart version is `2.6.3-pre.10`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251105085514-master-6f30c6f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
