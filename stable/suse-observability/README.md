...
Current chart version is `2.5.0-pre.5`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250909065735-master-da0e24c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
