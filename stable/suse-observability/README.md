...
Current chart version is `2.6.2-pre.35`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251030073701-master-1f65131"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
