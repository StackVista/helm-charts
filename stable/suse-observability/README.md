...
Current chart version is `2.3.2-pre.74`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250422092409-master-72e0610"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
