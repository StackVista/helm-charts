...
Current chart version is `2.10.3-pre.85`
...
| hbase.stackgraph.version | string | `"8.3.1"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260728061059-master-db6a93e"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.images[1].tag | string | `"20260728073137-main-82e11df"` | Tag used for the `stackpacks` Docker image |
