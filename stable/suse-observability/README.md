...
Current chart version is `2.3.4-pre.46`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250602094017-master-cd4ab7f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
