...
Current chart version is `2.10.2-pre.27`
...
| opentelemetry-collector.image.tag | string | `"v0.0.37"` | Container image tag for 'opentelemetry-collector' containers. |
...
| stackstate.stackpacks.image.version | string | `"20260603132720-master-3c48cf0"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
