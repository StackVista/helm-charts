...
Current chart version is `2.10.2-pre.36`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260605073734-master-9d08f1b"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
