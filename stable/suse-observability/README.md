...
Current chart version is `2.9.1-pre.26`
...
| file://../opentelemetry-collector | opentelemetry-collector | 0.108.0-stackstate.26 |
...
| opentelemetry-collector.image.tag | string | `"v0.0.28"` | Container image tag for 'opentelemetry-collector' containers. |
...
| stackstate.stackpacks.image.version | string | `"20260402094704-master-270d8ff"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
