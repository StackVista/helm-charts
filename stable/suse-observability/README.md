...
Current chart version is `2.8.1-pre.24`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260310125005-master-96f344a"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
