...
Current chart version is `2.7.1-pre.104`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260302104105-master-3ba0b4b"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
