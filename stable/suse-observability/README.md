...
Current chart version is `2.7.1-pre.82`
...
|------------|------|---------|
| file://../clickhouse/ | clickhouse | 3.6.9-suse-observability.10 |
| file://../common/ | common | * |
| file://../elasticsearch/ | elasticsearch | 8.19.4-stackstate.7 |
| file://../hbase/ | hbase | 0.2.114 |
| file://../kafka/ | kafka | 19.1.3-suse-observability.9 |
| file://../kafkaup-operator/ | kafkaup-operator | 0.1.15 |
...
| file://../victoria-metrics-single/ | victoria-metrics-0(victoria-metrics-single) | 0.8.53-stackstate.35 |
| file://../victoria-metrics-single/ | victoria-metrics-1(victoria-metrics-single) | 0.8.53-stackstate.35 |
| file://../zookeeper/ | zookeeper | 8.1.2-suse-observability.7 |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260211122441-master-62425c7"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
