...
Current chart version is `2.3.4-pre.34`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250523121546-master-18573c4"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
