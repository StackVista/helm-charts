...
Current chart version is `2.3.8-pre.18`
...
| hbase.stackgraph.version | string | `"7.11.2"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250731093216-master-95bf1fb"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
