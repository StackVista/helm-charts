...
Current chart version is `2.10.1-pre.46`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260526135959-master-8432223"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
