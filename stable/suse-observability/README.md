...
Current chart version is `2.9.1-pre.197`
...
| clickhouse.backup.image.tag | string | `"2.6.43-f6a6e1a0-main-48"` | Container image tag for 'clickhouse' backup containers. |
...
| elasticsearch.imageTag | string | `"8.19.15-f6a6e1a0-main-48"` | Elasticsearch image tag. Updated by updatecli. |
...
| hbase.hdfs.version | string | `"java21-9-6cb836e0-amd64-386"` | HDFS image build version (e.g. java21-8-27156f06-353). Derived from hadoop docker tag with semver prefix stripped. Updated by updatecli. |
| hbase.stackgraph.version | string | `"7.14.10"` |  |
...
| kafka.image.tag | string | `"3.9.2-f6a6e1a0-main-35"` | Kafka image tag. **Since StackState relies on this specific version, it's advised NOT to change this.** When changing this version, be sure to change the pod annotation stackstate.com/kafkaup-operator.kafka_version aswell, in order for the kafkaup operator to upgrade the inter broker protocol version |
...
| s3proxy.image.tag | string | `"3.1.0-f6a6e1a0-main-11"` | Image tag for S3Proxy |
...
| stackstate.components.aiAssistant.image.tag | string | `"20260506044638-101894e0"` | Tag used for the `ai-assistant` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260507115852-master-1c461fd"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.containerTools.image.tag | string | `"1.8.6-f6a6e1a0-main-51"` | Container image tag for container-tools containers. |
...
| stackstate.components.kafkaTopicCreate.image.tag | string | `"3.9.2-f6a6e1a0-main-35"` | Container image tag for kafka-topic-create containers. |
...
| stackstate.components.mcp.image.tag | string | `"20260506043325-5a52d75b"` | Tag used for the `mcp` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.router.mode.image.tag | string | `"1.8.6-f6a6e1a0-main-51"` | Container image tag for router mode containers. |
...
| stackstate.components.vmagent.image.tag | string | `"v1.142.0-f6a6e1a0-main-12"` |  |
...
| stackstate.components.workloadObserver.image.tag | string | `"99fb2e74-184-release"` | Tag used for the `workloadObserver` component Docker image.. |
...
| victoria-metrics-0.backup.setupCron.image.tag | string | `"1.8.6-f6a6e1a0-main-51"` | Container-tools image for cron setup. Updated by updatecli. |
| victoria-metrics-0.backup.vmbackup.image.tag | string | `"v1.142.0-f6a6e1a0-main-12"` | VM backup image tag. Updated by updatecli. |
...
| victoria-metrics-0.server.image.tag | string | `"v1.142.0-f6a6e1a0-main-12"` | Victoria Metrics server image tag. Updated by updatecli. |
...
| victoria-metrics-1.backup.setupCron.image.tag | string | `"1.8.6-f6a6e1a0-main-51"` | Container-tools image for cron setup. Updated by updatecli. |
| victoria-metrics-1.backup.vmbackup.image.tag | string | `"v1.142.0-f6a6e1a0-main-12"` | VM backup image tag. Updated by updatecli. |
...
| victoria-metrics-1.server.image.tag | string | `"v1.142.0-f6a6e1a0-main-12"` | Victoria Metrics server image tag. Updated by updatecli. |
...
| victoria-metrics.restore.image.tag | string | `"v1.142.0-f6a6e1a0-main-12"` | Container image tag for 'vmrestore' containers. |
...
| zookeeper.image.tag | string | `"3.9.5-f6a6e1a0-main-24"` | ZooKeeper image tag |
