...
Current chart version is `2.10.2-pre.112`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260625165433-master-75ca8cd"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
