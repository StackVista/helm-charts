...
| stackstate.stackpacks.images[0].version | string | `"20260919092831-master-ca3002f"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
