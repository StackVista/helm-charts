...
Current chart version is `2.3.4-pre.5`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250509110047-master-5010c7c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250509142811-master-6fade81"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
