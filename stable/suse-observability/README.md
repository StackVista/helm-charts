...
Current chart version is `2.3.1-pre.59`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250312150320-master-1f9655b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
