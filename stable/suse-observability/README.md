...
Current chart version is `2.7.1-pre.16`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260122120215-master-5cbb0d0"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
