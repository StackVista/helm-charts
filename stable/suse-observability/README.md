...
Current chart version is `2.6.3-pre.48`
...
| stackstate.stackpacks.image.version | string | `"20251119080544-master-71c4146"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
