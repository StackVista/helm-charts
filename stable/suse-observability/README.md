...
Current chart version is `2.10.4-pre.51`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260831195753-master-3c0b1f4"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
