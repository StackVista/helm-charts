...
Current chart version is `2.9.1-pre.141`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260429203216-master-a4e8a90"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
