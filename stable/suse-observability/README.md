...
Current chart version is `2.8.1-pre.7`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260304105846-master-0a19eee"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
