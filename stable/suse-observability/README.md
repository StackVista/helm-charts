...
Current chart version is `2.3.2-pre.53`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250414111146-master-2a68eb0"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
