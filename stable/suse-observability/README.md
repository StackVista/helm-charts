...
Current chart version is `2.7.1-pre.12`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260119113420-master-12b0f2c"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
