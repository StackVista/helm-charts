...
Current chart version is `2.2.1-pre.5`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241209180928-master-7fb0a0a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
