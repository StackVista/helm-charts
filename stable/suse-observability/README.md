...
Current chart version is `2.9.1-pre.198`
...
| stackstate.stackpacks.image.version | string | `"20260507143410-master-a4e7801"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
