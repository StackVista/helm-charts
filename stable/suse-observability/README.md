...
Current chart version is `2.10.3-pre.79`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260724160547-master-d9c80ca"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
