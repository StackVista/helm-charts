...
Current chart version is `2.6.3-pre.46`
...
| stackstate.stackpacks.image.version | string | `"20251111091323-master-b632f0b"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
