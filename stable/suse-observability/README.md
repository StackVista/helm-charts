...
Current chart version is `2.3.7-pre.10`
...
| stackstate.stackpacks.image.version | string | `"20250723143535-master-03e97fe"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
