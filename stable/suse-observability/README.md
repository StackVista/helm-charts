...
Current chart version is `2.3.8-pre.51`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250813143011-master-28aadd1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
