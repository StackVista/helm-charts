...
Current chart version is `2.7.1-pre.18`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260123143416-master-92457dd"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
