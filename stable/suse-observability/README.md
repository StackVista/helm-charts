...
Current chart version is `2.6.3-pre.69`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251121131623-master-4893a2f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
