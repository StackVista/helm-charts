...
Current chart version is `2.3.5-pre.18`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250618125226-master-3338da5"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250618120252-master-118e47a"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
