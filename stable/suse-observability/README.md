...
Current chart version is `2.3.4-pre.52`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250603161041-master-9a5aaef"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
