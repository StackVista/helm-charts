...
Current chart version is `2.10.1-pre.12`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260512144734-master-0c31257"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
