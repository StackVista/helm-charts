...
Current chart version is `2.0.2-pre.23`
...
| stackstate.stackpacks.image.version | string | `"20241001123952-master-0c60d49"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
