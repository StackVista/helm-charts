...
Current chart version is `2.2.2-pre.12`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241219090359-master-1c9a5e7"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
