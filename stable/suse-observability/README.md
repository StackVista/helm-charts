...
Current chart version is `2.6.4-pre.28`
...
| hbase.stackgraph.version | string | `"7.13.6"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251210104508-master-a744e0e"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
