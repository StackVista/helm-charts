...
Current chart version is `2.1.2-pre.45`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241202115534-master-bbb9d92"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
