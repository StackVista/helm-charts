...
Current chart version is `2.2.2-pre.56`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250120140354-master-49b3e34"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
