...
Current chart version is `2.10.2-pre.11`
...
| hbase.hdfs.version | string | `"3.4.3-so1"` | Full HDFS image tag. Updated by updatecli. |
| hbase.stackgraph.version | string | `"8.0.8"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260529083854-master-4e59758"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
