...
Current chart version is `2.8.2-pre.15`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260319161719-master-f70900a"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
