...
Current chart version is `2.9.1-pre.137`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260429143542-master-b4374fc"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
