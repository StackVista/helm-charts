...
Current chart version is `2.11.3-pre.16`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260923104101-master-4e17d00"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
