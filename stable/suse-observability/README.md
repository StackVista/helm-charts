...
Current chart version is `2.7.1-pre.40`
...
| file://../kafka/ | kafka | 19.1.3-suse-observability.6 |
| file://../kafkaup-operator/ | kafkaup-operator | * |
| file://../minio/ | minio | 8.0.10-stackstate.16 |
| file://../opentelemetry-collector | opentelemetry-collector | 0.108.0-stackstate.18 |
| file://../pull-secret/ | pull-secret | * |
| file://../suse-observability-sizing/ | suse-observability-sizing | 0.1.2 |
| file://../victoria-metrics-single/ | victoria-metrics-0(victoria-metrics-single) | 0.8.53-stackstate.31 |
| file://../victoria-metrics-single/ | victoria-metrics-1(victoria-metrics-single) | 0.8.53-stackstate.31 |
| file://../zookeeper/ | zookeeper | 8.1.2-suse-observability.4 |
...
| kafka.image.tag | string | `"3.9.1-4e2ea587-187"` | Kafka image tag. **Since StackState relies on this specific version, it's advised NOT to change this.** When changing this version, be sure to change the pod annotation stackstate.com/kafkaup-operator.kafka_version aswell, in order for the kafkaup operator to upgrade the inter broker protocol version |
...
| kafka.metrics.jmx.image.tag | string | `"0.20.0-d19cf0ff-182"` | Kafka JMX exporter image tag |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260128150003-master-f71c341"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.kafkaTopicCreate.image.tag | string | `"3.9.1-4e2ea587-187"` | Container image tag for kafka-topic-create containers. |
...
| stackstate.stackpacks.image.version | string | `"20260128083850-master-5dc5488"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
...
| zookeeper.image.tag | string | `"3.9.3-eda4e09e-204"` | ZooKeeper image tag |
