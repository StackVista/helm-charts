...
Current chart version is `2.2.2-pre.67`
...
| https://helm.stackstate.io | anomaly-detection | 5.2.0-snapshot.146 |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250124144504-master-47fccff"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
