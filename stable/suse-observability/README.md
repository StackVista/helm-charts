...
Current chart version is `2.11.2-pre.32`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260919173254-master-5674676"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.images[1].tag | string | `"20260922100647-main-0a0fa69"` | Tag used for the `stackpacks` Docker image |
