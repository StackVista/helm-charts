...
Current chart version is `2.9.1-pre.149`
...
| clickhouse.backup.image.tag | string | `"2.6.43-47a710b2-177-release"` | Container image tag for 'clickhouse' backup containers. |
...
| clickhouse.image.tag | string | `"25.9.5-c65c568c-release-167"` | Container image tag for 'clickhouse' containers. |
...
| elasticsearch.imageTag | string | `"8.19.4-c4527168-release-214"` | Elasticsearch image tag. Updated by updatecli. |
...
| hbase.stackgraph.version | string | `"7.14.5"` |  |
...
| kubernetes-rbac-agent.containers.rbacAgent.image.tag | string | `"e78c10a7-712-release"` |  |
...
| stackstate.components.aiAssistant.image.tag | string | `"20260430143355-762f5358"` | Tag used for the `ai-assistant` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260430123344-master-d359873"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.clickhouseCleanup.image.tag | string | `"25.9.5-c65c568c-release-167"` | Container image tag for 'clickhouseCleanup' containers. |
...
| stackstate.components.containerTools.image.tag | string | `"1.8.6-fa52bb17-main-4"` | Container image tag for container-tools containers. |
...
| stackstate.components.mcp.image.tag | string | `"20260430144043-56d9899d"` | Tag used for the `mcp` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.router.mode.image.tag | string | `"1.8.6-fa52bb17-main-4"` | Container image tag for router mode containers. |
...
| stackstate.components.workloadObserver.image.tag | string | `"864f55e0-171-release"` | Tag used for the `workloadObserver` component Docker image.. |
...
| stackstate.stackpacks.image.version | string | `"20260429134521-master-5097b26"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
...
| victoria-metrics-0.backup.setupCron.image.tag | string | `"1.8.6-fa52bb17-main-4"` | Container-tools image for cron setup. Updated by updatecli. |
...
| victoria-metrics-1.backup.setupCron.image.tag | string | `"1.8.6-fa52bb17-main-4"` | Container-tools image for cron setup. Updated by updatecli. |
