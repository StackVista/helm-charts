...
Current chart version is `2.3.1-pre.36`
...
| https://helm.stackstate.io | kubernetes-rbac-agent | 0.0.6 |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250225130215-master-1c47448"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
