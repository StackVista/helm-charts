...
Current chart version is `2.3.8-pre.21`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250801103801-master-aea700b"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
