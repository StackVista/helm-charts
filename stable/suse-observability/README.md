...
Current chart version is `2.3.1-pre.40`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250226094611-master-dc98ee0"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
