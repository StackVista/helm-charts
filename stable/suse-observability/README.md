...
Current chart version is `2.10.3-pre.25`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260703120158-master-6dc11b5"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
