...
Current chart version is `2.2.2-pre.38`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250113085357-master-b7cc66a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
