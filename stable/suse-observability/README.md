...
Current chart version is `2.2.2-pre.75`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250129092413-master-0f741ec"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
