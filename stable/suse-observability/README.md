...
Current chart version is `2.8.2-pre.11`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260319122905-master-bcbf730"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
