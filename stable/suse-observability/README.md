...
Current chart version is `2.7.1-pre.69`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260205223239-master-e38def5"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
