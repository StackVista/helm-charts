...
Current chart version is `2.8.1-pre.34`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260312151831-master-68681b3"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
