...
Current chart version is `2.10.4-pre.37`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260819134218-master-4b6e746"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
