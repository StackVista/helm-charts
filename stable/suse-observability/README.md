...
Current chart version is `2.3.4-pre.9`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250514073421-master-1dd79d8"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
