...
Current chart version is `2.10.3-pre.65`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260721152011-master-68e5e0a"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
