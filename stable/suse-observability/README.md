...
Current chart version is `2.0.3-pre.46`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241023133226-master-a9f30a7"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
