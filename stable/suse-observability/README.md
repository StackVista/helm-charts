...
Current chart version is `2.11.1-pre.18`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260914133543-master-40af7a5"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
