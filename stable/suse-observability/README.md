...
Current chart version is `2.3.4-pre.20`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250515171413-master-7ad1a8e"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
