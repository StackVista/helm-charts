...
Current chart version is `2.6.4-pre.23`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251208073835-master-3e602a0"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
