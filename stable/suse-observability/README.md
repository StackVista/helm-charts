...
Current chart version is `2.3.2-pre.5`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250319123048-master-d4c5db3"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
