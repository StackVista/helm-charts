...
Current chart version is `2.1.2-pre.34`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241125121624-master-18cb382"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
