...
Current chart version is `2.1.2-pre.44`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241129154453-master-1d4855a"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
