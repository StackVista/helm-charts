...
Current chart version is `2.9.1-pre.169`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260504072649-master-d95aa4a"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
