...
Current chart version is `2.7.1-pre.108`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260303123724-master-c398b85"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
