...
Current chart version is `2.6.4-pre.46`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251215122620-master-68b79f5"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
