...
Current chart version is `2.6.1-pre.1`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250929103700-master-b068fa2"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
