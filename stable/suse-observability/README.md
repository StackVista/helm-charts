...
| stackstate.stackpacks.image.version | string | `"20241018124728-master-6002a37"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
