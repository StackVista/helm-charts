...
Current chart version is `2.9.1-pre.184`
...
| hbase.stackgraph.version | string | `"7.14.7"` |  |
...
| opentelemetry-collector.image.tag | string | `"v0.0.32"` | Container image tag for 'opentelemetry-collector' containers. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260505192524-master-3ee0189"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
