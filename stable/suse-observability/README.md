...
Current chart version is `2.9.1-pre.19`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260401103650-master-0e15a3f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
