...
Current chart version is `2.10.4-pre.71`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260907074453-master-cb932f4"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
