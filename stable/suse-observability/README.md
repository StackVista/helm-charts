...
Current chart version is `2.6.4-pre.21`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251204143800-master-52f2f64"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
