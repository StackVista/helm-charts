...
Current chart version is `2.9.1-pre.70`
...
| file://../zookeeper/ | zookeeper | 8.1.2-suse-observability.22 |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260414085432-master-62aeaa4"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
