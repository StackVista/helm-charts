...
Current chart version is `2.3.7-pre.19`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250728130220-master-4a496ce"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
