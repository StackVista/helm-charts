...
Current chart version is `2.6.4-pre.18`
...
| stackstate.stackpacks.image.version | string | `"20251128123357-master-17d6c32"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
