...
Current chart version is `2.9.1-pre.118`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260422143255-master-2e4db1a"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
