...
Current chart version is `2.10.1-pre.45`
...
| hbase.hdfs.version | string | `"java21-9-0f68a2cf-release-399"` | HDFS image build version (e.g. java21-8-27156f06-353). Derived from hadoop docker tag with semver prefix stripped. Updated by updatecli. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260526120526-master-5dd45b2"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
