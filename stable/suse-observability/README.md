...
Current chart version is `2.3.8-pre.35`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250806132540-master-1ca5849"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
