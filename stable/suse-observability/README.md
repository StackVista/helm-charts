...
Current chart version is `2.1.2-pre.42`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241129084852-master-69145c1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
