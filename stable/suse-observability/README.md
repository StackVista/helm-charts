...
Current chart version is `2.1.2-pre.4`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241029141238-master-64f529c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
