...
Current chart version is `2.5.1-pre.34`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250922090134-master-0c5f6d3"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
