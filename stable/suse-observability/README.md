...
Current chart version is `2.10.1-pre.10`
...
| hbase.stackgraph.version | string | `"8.0.0"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260512140851-master-ad595e6"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
