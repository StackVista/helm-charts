...
Current chart version is `2.10.4-pre.18`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260813112458-master-53b7f7b"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
