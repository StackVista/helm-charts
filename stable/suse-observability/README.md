...
Current chart version is `2.10.3-pre.51`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260715073817-master-a8f4367"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
