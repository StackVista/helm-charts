...
Current chart version is `2.5.1-pre.33`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250919181803-master-acfd552"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
