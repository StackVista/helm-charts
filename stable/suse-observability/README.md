...
Current chart version is `2.6.1-pre.6`
...
| file://../opentelemetry-collector | opentelemetry-collector | 0.108.0-stackstate.3 |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251002151235-master-5742011"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
