...
Current chart version is `2.9.1-pre.115`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260422102125-master-4ff4b40"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
