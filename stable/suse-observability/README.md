...
Current chart version is `2.4.1-pre.4`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250820143359-master-7cb8e40"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
