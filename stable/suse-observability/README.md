...
Current chart version is `2.10.3-pre.59`
...
| clickhouse.backup.image.tag | string | `"2.7.2-so5"` | Container image tag for 'clickhouse' backup containers. |
...
| elasticsearch.prometheus-elasticsearch-exporter.image.tag | string | `"1.10.0-so10"` | Elasticsearch Prometheus exporter image tag. Updated by updatecli. |
...
| global.wait.image.tag | string | `"1.0.12-so7"` | Container image tag for wait containers. |
...
| hbase.stackgraph.version | string | `"8.1.10"` |  |
...
| s3proxy.image.tag | string | `"3.2.0-so5"` | Image tag for S3Proxy |
...
| stackstate.components.aiAssistant.image.tag | string | `"20260710120907-41739e51"` | Tag used for the `ai-assistant` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260720055624-master-c92c3c1"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.containerTools.image.tag | string | `"1.8.6-so14"` | Container image tag for container-tools containers. |
...
| stackstate.components.mcp.image.tag | string | `"20260710120831-fd6599ee"` | Tag used for the `mcp` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.nginxPrometheusExporter.image.tag | string | `"1.5.1-so10"` | Container image tag for nginx-prometheus-exporter containers. |
...
| stackstate.components.router.mode.image.tag | string | `"1.8.6-so14"` | Container image tag for router mode containers. |
...
| stackstate.components.vmagent.image.tag | string | `"1.144.0-so9"` |  |
...
| stackstate.components.workloadObserver.image.tag | string | `"7aeab0ec-1018-release"` | Tag used for the `workloadObserver` component Docker image.. |
...
| stackstate.stackpacks.images[0].version | string | `"20260710120631-master-d66e960"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
...
| stackstate.stackpacks.images[1].tag | string | `"20260717120517-main-4d1aa7a"` | Tag used for the `stackpacks` Docker image |
...
| stackstate.stackpacks.images[2].tag | string | `"20260720112426-main-a311672"` | Tag used for the `stackpacks` Docker image |
...
| victoria-metrics-0.backup.setupCron.image.tag | string | `"1.8.6-so14"` | Container-tools image for cron setup. Updated by updatecli. |
| victoria-metrics-0.backup.vmbackup.image.tag | string | `"1.144.0-so10"` | VM backup image tag. Updated by updatecli. |
...
| victoria-metrics-0.server.image.tag | string | `"1.144.0-so9"` | Victoria Metrics server image tag. Updated by updatecli. |
...
| victoria-metrics-1.backup.setupCron.image.tag | string | `"1.8.6-so14"` | Container-tools image for cron setup. Updated by updatecli. |
| victoria-metrics-1.backup.vmbackup.image.tag | string | `"1.144.0-so10"` | VM backup image tag. Updated by updatecli. |
...
| victoria-metrics-1.server.image.tag | string | `"1.144.0-so9"` | Victoria Metrics server image tag. Updated by updatecli. |
...
| victoria-metrics.restore.image.tag | string | `"1.144.0-so9"` | Container image tag for 'vmrestore' containers. |
...
| zookeeper.image.tag | string | `"3.9.5-so15"` | ZooKeeper image tag |
