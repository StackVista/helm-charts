...
Current chart version is `2.3.1-pre.37`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250225211958-master-30af82f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
