...
Current chart version is `2.6.4-pre.54`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251218122601-master-71f5e9f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
