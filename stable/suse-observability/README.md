...
Current chart version is `2.2.2-pre.16`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20241223135033-master-a56a0e0"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
