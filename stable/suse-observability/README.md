...
| stackstate.stackpacks.images[0].schemaVersion | string | `"1.0"` | Stackpack schema version |
...
| stackstate.stackpacks.images[1].deploymentModeOverride | string | `""` | Use the stackpacks from another deployment mode than StackState is running in |
...
| stackstate.stackpacks.images[1].version | string | `"20260703131618-STAC-24722-community-stackpacks-in-contrib-5a6af30"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
...
| stackstate.stackpacks.images[2].version | string | `"20260703131618-STAC-24722-community-stackpacks-in-contrib-5a6af30"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
