...
Current chart version is `2.6.4-pre.67`
...
| hbase.stackgraph.version | string | `"7.13.14"` | The StackGraph server version, must be compatible with the StackState version |
