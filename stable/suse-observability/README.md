...
Current chart version is `2.11.2-pre.8`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260916122142-master-37c0f1a"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
