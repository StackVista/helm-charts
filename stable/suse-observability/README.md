...
Current chart version is `2.10.4-pre.30`
...
| elasticsearch.imageTag | string | `"8.19.16-so11"` | Elasticsearch image tag. Updated by updatecli. |
...
| stackstate.components.aiAssistant.image.tag | string | `"20260818035140-f3be0255"` | Tag used for the `ai-assistant` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260818073155-master-b3428c2"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.mcp.image.tag | string | `"20260818033424-3d67dda0"` | Tag used for the `mcp` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.workloadObserver.image.tag | string | `"64188fd0-1029-release"` | Tag used for the `workloadObserver` component Docker image.. |
...
| stackstate.stackpacks.images[0].version | string | `"20260819085355-master-d64d9bc"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
