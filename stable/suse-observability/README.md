...
Current chart version is `2.3.4-pre.32`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250520105356-master-7374ae1"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.stackpacks.image.version | string | `"20250521070851-master-4e05df6"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
