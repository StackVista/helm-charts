...
Current chart version is `2.10.3-pre.55`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260715120914-master-5128b5d"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.stackpacks.images[1].tag | string | `"20260715105341-main-a50fa57"` | Tag used for the `stackpacks` Docker image |
