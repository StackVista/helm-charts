...
Current chart version is `2.9.1-pre.5`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260326105610-master-8d0ac1c"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
