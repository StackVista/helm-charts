...
Current chart version is `2.7.1-pre.4`
...
| stackstate.stackpacks.image.version | string | `"20260114104000-master-5ee9c82"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
