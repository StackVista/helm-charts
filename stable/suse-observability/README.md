...
Current chart version is `2.9.1-pre.202`
...
| hbase.stackgraph.version | string | `"7.14.11"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260507155431-master-dcaab9a"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
