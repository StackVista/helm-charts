...
Current chart version is `2.8.2-pre.36`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260325125836-master-c8cc03b"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
