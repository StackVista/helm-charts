...
Current chart version is `2.3.1-pre.52`
...
| hbase.stackgraph.version | string | `"7.9.3"` | The StackGraph server version, must be compatible with the StackState version |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250307114121-master-b9e09fc"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
