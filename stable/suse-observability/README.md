...
Current chart version is `2.3.4-pre.36`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250523193403-master-6f684f7"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
