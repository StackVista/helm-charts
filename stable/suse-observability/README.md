...
Current chart version is `2.10.3-pre.17`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260702071632-master-501e81f"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
