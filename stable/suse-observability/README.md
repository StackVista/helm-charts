...
Current chart version is `2.7.1-pre.75`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260209134641-master-e606845"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
