...
| stackstate.stackpacks.image.version | string | `"20250519134436-master-5338c6b"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
