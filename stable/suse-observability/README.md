...
Current chart version is `2.10.3-pre.81`
...
| hbase.stackgraph.version | string | `"8.3.0"` |  |
...
| stackstate.components.aiAssistant.image.tag | string | `"20260727045012-ff93fb37"` | Tag used for the `ai-assistant` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260727105856-master-5ea5c81"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
...
| stackstate.components.mcp.image.tag | string | `"20260727043311-6608c5f9"` | Tag used for the `mcp` component Docker image; this will override `stackstate.components.all.image.tag` on a per-service basis. |
...
| stackstate.stackpacks.images[1].tag | string | `"20260727104157-main-0569ab4"` | Tag used for the `stackpacks` Docker image |
...
| stackstate.stackpacks.images[2].tag | string | `"20260727104204-main-46f97c4"` | Tag used for the `stackpacks` Docker image |
