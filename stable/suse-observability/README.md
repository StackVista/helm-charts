...
Current chart version is `2.9.1-pre.107`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260421113642-master-6f4d91d"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
