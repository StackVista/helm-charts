...
Current chart version is `2.5.1-pre.38`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250924094137-master-721cae2"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
