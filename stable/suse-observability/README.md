...
Current chart version is `2.3.6-pre.5`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250623162858-master-25b156f"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
