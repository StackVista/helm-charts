...
Current chart version is `2.9.1-pre.190`
...
| hbase.stackgraph.version | string | `"7.14.8"` |  |
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260506141004-master-9446a65"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
