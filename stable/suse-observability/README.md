...
Current chart version is `2.2.2-pre.17`
...
| stackstate.stackpacks.image.version | string | `"20241230144310-master-cd4bec0"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
