...
Current chart version is `2.10.2-pre.82`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260618094145-master-824ff79"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
