...
Current chart version is `2.6.1-pre.24`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20251007135629-master-499c0e1"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
