...
Current chart version is `2.6.4-pre.94`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260112132812-master-65f37c9"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
