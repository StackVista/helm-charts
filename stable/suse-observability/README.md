...
Current chart version is `2.2.2-pre.45`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250113143653-master-2f985e3"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
