...
Current chart version is `2.8.1-pre.5`
...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260304093457-master-fd6f58c"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
