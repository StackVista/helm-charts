...
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20260410120514-master-4cf7dbd"` | The default tag used for all stateless components of StackState; individual service `tag`s can be overridden (see below). |
