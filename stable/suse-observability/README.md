...
| stackstate.stackpacks.image.version | string | `"20250113103705-master-08ca0e8"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
