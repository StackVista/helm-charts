# Victoria Metrics Helm Chart for Single Version
 ...
 ![Version: 0.8.53-stackstate.32](https://img.shields.io/badge/Version-0.8.53--stackstate.32-informational?style=flat-square)
...
| backup.setupCron.image.tag | string | `"1.8.1-bci"` | Tag of the image for the busybox |
