# Victoria Metrics Helm Chart for Single Version
 ...
 ![Version: 0.8.53-stackstate.20](https://img.shields.io/badge/Version-0.8.53--stackstate.20-informational?style=flat-square)
...
| backup.setupCron.image.tag | string | `"stac-21887-drop-useradd"` | Tag of the image for the busybox |
