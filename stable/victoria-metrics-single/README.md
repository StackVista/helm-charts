# Victoria Metrics Helm Chart for Single Version
 ...
 ![Version: 0.8.53-stackstate.15](https://img.shields.io/badge/Version-0.8.53--stackstate.15-informational?style=flat-square)
...
| backup.setupCron.image.tag | string | `"1.5.2"` | Tag of the image for the busybox |
