...
Current chart version is `3.5.3`
...
| checksAgent.image.tag | string | `"3.0.3"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"3.0.3"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"3.0.3"` | Default container image tag. |
