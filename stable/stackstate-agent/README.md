...
| checksAgent.image.tag | string | `"2.17.1"` | Default container image tag. |
...
| checksAgent.resources.limits.memory | string | `"1024Mi"` |  |
| checksAgent.resources.requests.cpu | string | `"100m"` | Memory resource requests. |
| checksAgent.resources.requests.memory | string | `"256Mi"` |  |
...
| clusterAgent.image.repository | string | `"stackstate/stackstate-agent"` | Base container image repository. |
...
| clusterAgent.logLevel | string | `"INFO"` | Logging level for stackstate-agent processes. |
| clusterAgent.nodeSelector | object | `{}` | Node labels for pod assignment. |
| clusterAgent.priorityClassName | string | `""` | Priority class for stackstate-agent pods. |
...
| nodeAgent.containers.agent.image.tag | string | `"2.17.1"` | Default container image tag. |
...
| nodeAgent.containers.agent.resources.limits.cpu | string | `"400m"` | Memory resource limits. |
| nodeAgent.containers.agent.resources.limits.memory | string | `"256Mi"` |  |
| nodeAgent.containers.agent.resources.requests.cpu | string | `"100m"` | Memory resource requests. |
| nodeAgent.containers.agent.resources.requests.memory | string | `"128Mi"` |  |
...
| nodeAgent.containers.processAgent.resources.requests.cpu | string | `"100m"` | Memory resource requests. |
