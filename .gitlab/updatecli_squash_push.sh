...
# signed commit, then delete the working branch on origin.
#
...
# gitlab SCM with workingbranch=true).
#
...
REPO_URL="https://gitlab-ci-token:${GITLAB_TOKEN}@gitlab.com/stackvista/devops/helm-charts.git"
...
# One signed commit (configure_git.sh sets commit.gpgsign=true globally).
